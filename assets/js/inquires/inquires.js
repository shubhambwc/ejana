...
$(document).on('click', '.delete-btn', function (event) {
  var inquiryId = $(event.currentTarget).attr('data-id');
  swal({
...
module.exports = __webpack_require__(/*! C:\EjanaPortal\resources\assets\js\inquires\inquires.js */"./resources/assets/js/inquires/inquires.js");
