  ...
  $('#searchText').on('keyup', function () {
    ...
    $(document).on('click', '.close-sign', function () {
      ...
      $('.side-menus').show().filter(function () {
        if (searchText != '') {
          $('.side-menus.dropdown.active ul').addClass('d-block');
        }
      });
      $('.close-sign').hide();
      $('.search-sign').show();
...
module.exports = __webpack_require__(/*! C:\EjanaPortal\resources\assets\js\sidebar_menu_search\sidebar_menu_search.js */"./resources/assets/js/sidebar_menu_search/sidebar_menu_search.js");
