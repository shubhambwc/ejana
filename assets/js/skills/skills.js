...
$(document).on('click', '.delete-btn', function (event) {
  ...
  swal({
    ...
    window.livewire.emit('deleteSkill', skillId);
  });
});
...
module.exports = __webpack_require__(/*! C:\EjanaPortal\resources\assets\js\skills\skills.js */"./resources/assets/js/skills/skills.js");
