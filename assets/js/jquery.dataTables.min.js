...
(function (h) {
  ...
  function Ia(a) {
    ...
    for (f = b.length; e < f; e++) {
      if (l = b[e], u = [], !l.sType && l._sManualType) l.sType = l._sManualType;else if (!l.sType) {
        g = 0;
  ...
  function Ka(a, b, c, d) {
    var e = [],
      ...
      if ("string" === typeof a) {
        ...
        G = function G(a) {
      if (c === k || c === i) j = l[i], h = a.innerHTML.trim(), j && j._bAttrSrc ? (N(j.mData._)(d, h), u(j.mData.sort, a), u(j.mData.type, a), u(j.mData.filter, a)) : q ? (j._setter || (j._setter = N(j.mData)), j._setter(d, h)) : d[i] = h;
      i++;
    };
  ...
  function Ja(a, b, c, d) {
    ...
    if (null === e.nTr) {
      ...
      for (q = a.aoColumns.length; l < q; l++) {
        m = a.aoColumns[l];
        i = (k = c ? !1 : !0) ? H.createElement(m.sCellType) : d[l];
        i._DT_CellIndex = {
          row: b,
          column: l
        };
  ...
  function mb(a) {
    ...
    for (c = l.length; b < c; b++) {
      f = l[b], d = h(f.nTh).addClass(f.sClass), i && d.appendTo(e), a.oFeatures.bSort && (d.addClass(f.sSortingClass), !1 !== f.bSortable && (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Oa(a, f.nTh, b))), f.sTitle != d[0].innerHTML && d.html(f.sTitle), Pa(a, "header")(a, d, f, m);
    }
  ...
  function rb(a) {
    var b = a.oClasses,
      ...
      b != e.sSearch && (ha(a, {
        ...
        m = h("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", f ? Qa(i, f) : i).on("mouseup", function () {
      setTimeout(function () {
        i.call(m[0]);
      }, 10);
    ...
    h(a.nTable).on("search.dt.DT", function (b, c) {
      if (a === c) try {
        m[0] !== H.activeElement && m.val(e.sSearch);
      } catch (d) {}
    });
    return b[0];
  }
  ...
  function ma(a) {
    ...
    if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, aa(a);else {
      ...
      if ("" === c) {
        t.width = "100%";
        if (V && (p.find("tbody").height() > j.offsetHeight || "scroll" == l.css("overflow-y"))) t.width = w(p.outerWidth() - b);
        f = p.outerWidth();
  ...
  function Ha(a) {
    ...
    if (d || !u && !f && !e && j == W(a) && j == m.length) for (n = 0; n < j; n++) {
      i = ba(a, n), null !== i && (c[i].sWidth = w(m.eq(n).width()));
    } else {
      ...
      for (n = 0; n < i.length; n++) {
        o = c[i[n]], m[n].style.width = null !== o.sWidthOrig && "" !== o.sWidthOrig ? w(o.sWidthOrig) : "", o.sWidthOrig && f && h(m[n]).append(h("<div/>").css({
          width: o.sWidthOrig,
          margin: 0,
          padding: 0,
          border: 0,
      ...
      for (n = e = 0; n < i.length; n++) {
        k = h(m[n]), g = k.outerWidth() - k.width(), k = p.bBounding ? Math.ceil(m[n].getBoundingClientRect().width) : k.outerWidth(), e += k, c[i[n]].sWidth = w(k - g);
      }
  ...
  function Y(a) {
    ...
    f = function f(a) {
      a.length && !Array.isArray(a[0]) ? m.push(a) : h.merge(m, a);
    };
      ...
      if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);else {
        ...
        for (i = u.length; j < i; j++) {
          ...
          if (o.nTable == this || o.nTHead && o.nTHead.parentNode == this || o.nTFoot && o.nTFoot.parentNode == this) {
            var r = g.bRetrieve !== k ? g.bRetrieve : l.bRetrieve;
  ...
  h.extend(_r.prototype, {
    ...
    iterator: function iterator(a, b, c, d) {
      ...
      if (e.length || d) {
        a = new _r(l, a ? e.concat.apply([], e) : e);
        b = a.selector;
        b.rows = s.rows;
        b.cols = s.cols;
        b.opts = s.opts;
  ...
  var bb = function bb(a, b, c, d, e) {
    ...
    for (m = b.length; h < m; h++) {
      j = b[h] && b[h].split && !b[h].match(/[\[\(:]/) ? b[h].split(",") : [b[h]];
      l = 0;

      for (n = j.length; l < n; l++) {
        (g = c(typeof j[l] === "string" ? j[l].trim() : j[l])) && g.length && (f = f.concat(g));
      }
    }
  ...
  h.each(["column", "row", "cell"], function (a, b) {
    o(b + "s().every()", function (a) {
      ...
      return this.iterator(b, function (f, g, h, i, m) {
        a.call(e[b](g, b === "cell" ? h : d, b === "cell" ? d : k), g, h, i, m);
      });
    });
  });
