...
$(document).on('click', '.delete-btn', function (event) {
  ...
  swal({
    ...
    window.livewire.emit('deleteSalaryPeriod', salaryPeriodId);
  });
});
...
module.exports = __webpack_require__(/*! C:\EjanaPortal\resources\assets\js\salary_periods\salary_periods.js */"./resources/assets/js/salary_periods/salary_periods.js");
