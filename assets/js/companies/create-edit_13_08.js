...
$(document).ready(function () {
  ...
  $('#validateTab1').on('click', function () {
    ...
    var errorCount = 0;
    $('#section_tab1').find('input,select').each(function(){
  ...
  $('#validateTab2').on('click', function () {
    ...
    var errorCount = 0;
    $('#section_tab2').find('input,select').each(function(){
    if($(this).prop('required')){
       if(!$(this).val()){
            $(this).addClass("error-input");
            errorCount++;
  ...
  $('#validateTab3').on('click', function () {
    ...
    var errorCount = 0;
    $('#section_tab3').find('input,select').each(function(){
    if($(this).prop('required')){
       if(!$(this).val()){
            $(this).addClass("error-input");
            errorCount++;
  ...
  $('#validateTab4').on('click', function () {
    ...
    var errorCount = 0;
    $('#section_tab4').find('input,select').each(function(){
    if($(this).prop('required')){
       if(!$(this).val()){
            $(this).addClass("error-input");
            errorCount++;
  ...
  $('#validateTab5').on('click', function () {
    ...
    var errorCount = 0;
    $('#section_tab5').find('input,select').each(function(){
    if($(this).prop('required')){
       if(!$(this).val()){
            $(this).addClass("error-input");
            errorCount++;
  ...
  $('#birthDate1').datetimepicker(DatetimepickerDefaults({
    format: 'YYYY-MM-DD',
    useCurrent: true,
    sideBySide: true,
    maxDate: new Date()
    ...
    $('#when_need').datetimepicker(DatetimepickerDefaults({
    format: 'YYYY-MM-DD',
    useCurrent: true,
    sideBySide: true,
   minDate: new Date()
    ...
    $('#service_date_time').datetimepicker(DatetimepickerDefaults({
...
module.exports = __webpack_require__(/*! C:\EjanaPortal\resources\assets\js\companies\create-edit.js */"./resources/assets/js/companies/create-edit.js");
