  ...
  $.ajax({
    ...
    success: function success(result) {
      if (result.success) {
        ...
        $('#showImage').append('<img src="' + result.data.job.company.company_url + '" class="img-responsive users-avatar-img employee-img mr-2" />');
...
module.exports = __webpack_require__(/*! C:\EjanaPortal\resources\assets\js\jobs\reported_jobs.js */"./resources/assets/js/jobs/reported_jobs.js");
