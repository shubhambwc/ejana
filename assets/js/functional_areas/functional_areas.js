...
$(document).on('click', '.delete-btn', function (event) {
  var functionalAreaId = $(event.currentTarget).attr('data-id');
  swal({
    ...
    window.livewire.emit('deleteFunctionalArea', functionalAreaId);
  });
});
...
var source = $('#actionTemplate')[0].innerHTML;
...
module.exports = __webpack_require__(/*! C:\EjanaPortal\resources\assets\js\functional_areas\functional_areas.js */"./resources/assets/js/functional_areas/functional_areas.js");
