...
$(document).on('click', '.delete-btn', function (event) {
  ...
  swal({
    ...
    window.livewire.emit('deleteDegree', requiredDegreeLevelId);
  });
});
...
module.exports = __webpack_require__(/*! C:\EjanaPortal\resources\assets\js\required_degree_levels\required_degree_levels.js */"./resources/assets/js/required_degree_levels/required_degree_levels.js");
