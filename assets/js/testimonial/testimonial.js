...
$(document).ready(function () {
  $(document).on('submit', '#addNewForm', function (e) {
    ...
    if ($('#customerName').val().length > 50) {
      displayErrorMessage('Customer Name should be greater than 50 character');
      setTimeout(function () {
...
module.exports = __webpack_require__(/*! C:\EjanaPortal\resources\assets\js\testimonial\testimonial.js */"./resources/assets/js/testimonial/testimonial.js");
