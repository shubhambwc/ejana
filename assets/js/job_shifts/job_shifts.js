...
$(document).on('click', '.delete-btn', function (event) {
  ...
  swal({
    ...
    window.livewire.emit('deleteJobShift', jobShiftId);
  });
});
...
module.exports = __webpack_require__(/*! C:\EjanaPortal\resources\assets\js\job_shifts\job_shifts.js */"./resources/assets/js/job_shifts/job_shifts.js");
