...
$(document).on('click', '.edit-btn', function (event) {
  ...
  ajaxCallInProgress();
  var maritalStatusId = $(event.currentTarget).attr('data-id');
...
module.exports = __webpack_require__(/*! C:\EjanaPortal\resources\assets\js\marital_status\marital_status.js */"./resources/assets/js/marital_status/marital_status.js");
