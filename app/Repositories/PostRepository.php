...
class PostRepository extends BaseRepository
{
    ...
    {
        $data['blogs'] = Post::with('media', 'postAssignCategories', 'user')->orderByDesc('created_at')->paginate(10);
    ...
    {
        $data['blog'] = Post::with('media', 'postAssignCategories', 'user')->findOrFail($blog->id);
        $data['blogCategories'] = PostCategory::withCount('postAssignCategories')->get();
        $data['blogCategory'] = PostCategory::pluck('name', 'id');
    ...
    public function getBlogDetailsByCategory($blogCategory)
    {
        ...
        $data['blogs'] = Post::with('postAssignCategories', 'user', 'media')
