...
class JobRepository extends BaseRepository
{
    ...
    {
        $data['jobTypes'] = JobType::withCount('jobs')->get();
        ...
        $data['advertise_image'] = FrontSetting::where('key', '=', 'advertise_image')->first();
    ...
    {
        return ReportedJob::with(['user.candidate', 'job.company'])->without(['user.media', 'user.country', 'user.state', 'user.city'])->select('reported_jobs.*')->orderBy('created_at',
