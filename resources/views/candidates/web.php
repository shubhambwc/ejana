...
Route::get('apply-application/{skill}', 'Web\HomeController@applytojob')->name('apply-to-job');
...
Route::group(['middleware' => ['auth', 'role:Admin', 'xss', 'verified.user'], 'prefix' => 'admin'], function () {
    ...
    Route::put('help-requester/{company}', 'CompanyController@update')->name('company.update');
