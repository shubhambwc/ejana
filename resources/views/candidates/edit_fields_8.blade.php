    ...
    <div class="row tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,@$postMetaArray['exprience'], ['id'=>'helpers_exprience','class' => 'form-control select-box required','required','placeholder' => 'How many years of experience do you have with computers?']) }}
                </div>
                </div>
                ...
                <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('type_of_device', __('web.helpers.what_type_of_device').':') }}<span class="text-danger">*</span>
                      {{ Form::select('type_of_device',
                      ...
                      ,@$postMetaArray['type_of_device'], ['class' => 'form-control select-box select_box_other','placeholder' => 'Select device']) }}
                      {{ Form::text('type_of_device_other', @$postMetaArray['type_of_device_other'], ['class' => (isset($postMetaArray['type_of_device']) && @$postMetaArray['type_of_device']=='other') ? 'form-control other_box_visible' : 'form-control other_box','placeholder' => 'Enter other']) }}

                </div>

                 <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('operating_systems', __('web.helpers.operating_system').':') }}<span class="text-danger">*</span>
                      {{ Form::select('operating_systems',
                      ['android' =>'Android' , 'iOS' =>'iOS' ,'macOS'=>'macOS','Windows'=>'Windows','other'=>'Other']
                      ,@$postMetaArray['operating_systems'], ['class' => 'form-control select-box select_box_other','placeholder' => 'Select OS']) }}
                     {{ Form::text('operating_systems_other', @$postMetaArray['operating_systems_other'], ['class' => (isset($postMetaArray['operating_systems']) && @$postMetaArray['operating_systems']=='other') ? 'form-control other_box_visible' : 'form-control other_box','placeholder' => 'Enter other']) }}
                ...
                <div class="radio_yes_box" id="do_you_have_tools_box" style="display:<?php if(isset($postMetaArray['do_you_have_tools']) && $postMetaArray['do_you_have_tools'] ==1){ echo 'block'; }else{ echo 'none'; }?>">
