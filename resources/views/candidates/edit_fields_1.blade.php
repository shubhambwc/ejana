    ...
    <div class="custom-form">
         <div id="message3">{{__("web.helpers.helpers_experience_as_a")}} {{$JobCategoryDetail->name}}.</div>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ['infant' =>'Infant(up to 1 year)' ,
                      'toddler' =>'Toddler(1-2 years)' ,
                      'toddler2_3'=>'Toddler(2-3years)',
                      'toddler3_4'=>'Toddler(3-4years)',
                      'schoolchild'=>'Schoolchild (7+ years)'
                      ]
                      ,@$postMetaArray['age_category_experience'],['id'=>'age_category_experience','class' => 'form-control select-box select_box_other_multiple required','multiple']) }}
                </div>
                </div>
                <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      {{ Form::label('child_quantity', __('web.helpers.child_quantity').':') }}<span class="text-danger">*</span>
                      ...
                      ,@$postMetaArray['child_quantity'], ['id'=>'child_quantity','class' => 'form-control select-box required']) }}
                </div>
                ...
                {{ Form::label('competent', __('web.helpers.are_you_competent_and_authorized_for_extra_care?').':') }}</br>
                {{ Form::radio('competent', '1',isset($postMetaArray['competent']) && $postMetaArray['competent'] ==1 ?true:false)  ,['onclick'=>'toggleCompetent("yes");', 'required']}} {{ __('web.helpers.yes') }}
                &nbsp;&nbsp;&nbsp;
                {{ Form::radio('competent', '0',isset($postMetaArray['competent']) && $postMetaArray['competent'] ==0 ?true:false),['onclick'=>'toggleCompetent("no");', 'class' => 'form-control check-box required'] }} {{ __('web.helpers.no') }}


                   <div id="competent_option_box" class="radio_yes_box" style="display:<?php if (isset($postMetaArray['competent']) && $postMetaArray['competent'] ==1){ echo 'block';}else{ echo 'none';}?>">
                    {{ Form::select('competent_option[]',
                      ...
                      'other'=>'Other']
                      ,@$postMetaArray['competent_option'], ['id'=>'competent_option_bh','class' => 'form-control select-box select_box_other_multiple','multiple']) }}
                     {{ Form::text('competent_option_other', @$postMetaArray['competent_option_other'], ['id'=>'competent_option_other','class' => (isset($postMetaArray['competent_option']) && in_array("other", $postMetaArray['competent_option'])) ? 'form-control other_box_visible' : 'form-control other_box','placeholder'=>'Enter Other']) }}
                  </div>
               ...
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      ...
                      {{ Form::text('extra_offer_other', @$postMetaArray['extra_offer_other'], ['id'=>'extra_offer_other','class' => (isset($postMetaArray['extra_offer']) && in_array("other", $postMetaArray['extra_offer'])) ? 'form-control other_box_visible' : 'form-control other_box','placeholder'=>'Enter Other']) }}
                 ...
                 <div class="form-group col-xl-12 col-md-12 col-sm-12">
                 <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                {{ Form::label('do_you_smoke', __('web.helpers.do_you_smoke').':') }}</br>
                {{ Form::radio('do_you_smoke', '1',isset($postMetaArray['do_you_smoke']) && $postMetaArray['do_you_smoke'] ==1 ? true:false)  ,['class' => 'form-control check-box']}} {{ __('web.helpers.yes') }}
                &nbsp;&nbsp;&nbsp;
                {{ Form::radio('do_you_smoke', '0',isset($postMetaArray['do_you_smoke']) && $postMetaArray['do_you_smoke'] ==0 ? true:false),['class' => 'form-control check-box'] }} {{ __('web.helpers.no') }}
    ...
    <div class="custom-form">
        ...
        <div class="row">
          ...
          <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  ...
                  ['id'=>'highest_education','class' => 'form-control select-box select_box_other required','placeholder' => 'Select Highest Education']) }}
    ...
    <div class="custom-form">
        ...
        <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  ...
                  ,@$postMetaArray['available_for'], ['id'=>'available_for','class' => 'form-control select-box required','multiple']) }}
        </div>
        </div>
        ...
        <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  {{ Form::label('prefered_reception', __('web.helpers.preferred_reception')) }}<span class="text-danger">*</span>
                  ...
                  , @$postMetaArray['prefered_reception'], ['id'=>'prefered_reception','class' => 'form-control select-box select_box_other_multiple required','multiple']) }}
        </div>
        </div>
