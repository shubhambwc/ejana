    ...
    <div class="row tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,@$postMetaArray['exprience'], ['id'=>'helpers_exprience','class' => 'form-control select-box required','required','placeholder' => 'How many years of experience do you have in Music?']) }}
                </div>
                </div>
               ...
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      {{ Form::label('extra_offer', __('web.helpers.extra_offer').':') }}
                      {{ Form::select('extra_offer[]',
                      ['songwriter' =>'Song Writer',
                      'beatmaker' =>'Beat Maker',
                      'music_instrument'=>'Music Instrument',
                      'other'=>'Other']
                      , @$postMetaArray['extra_offer'], ['id'=>'extra_offer','class' => 'form-control select-box select_box_other_multiple','multiple']) }}
               ...
               <div class="form-group col-xl-12 col-md-12 col-sm-12">
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      {{ Form::label('kind_of_lesson', __('web.helpers.what_kind_of_lesson').':') }}
                      ...
                      'other'=>'Other']
                      , @$postMetaArray['kind_of_lesson'], ['id'=>'kind_of_lesson','class' => 'form-control select-box select_box_other_multiple','multiple']) }}

                 		{{ Form::text('kind_of_lesson_other',@$postMetaArray['kind_of_lesson_other'], ['id'=>'kind_of_lesson_other','class' => (isset($postMetaArray['kind_of_lesson']) && in_array("other", @$postMetaArray['kind_of_lesson'])) ? 'form-control other_box_visible' : 'form-control other_box','placeholder' => 'Enter Other']) }}
                 </div>
               ...
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      ...
                      'experts'=>'Experts',
                      'other'=>'Other']
                      , @$postMetaArray['lesson_level'], ['id'=>'lesson_level','class' => 'form-control select-box select_box_other_multiple','multiple']) }}
               ...
               <div class="form-group col-xl-12 col-md-12 col-sm-12">
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      {{ Form::label('lesson_type', __('web.helpers.lesson_type').':') }}
                      {{ Form::select('lesson_type[]',
                      ['private' =>'Private Lesson' ,
                      'groups' =>'Groups Lesson' ,
                      'other'=>'Other']
                      , @$postMetaArray['lesson_type'], ['id'=>'lesson_type','class' => 'form-control select-box select_box_other_multiple','multiple']) }}
                      {{ Form::text('lesson_type_other',@$postMetaArray['lesson_type_other'], ['id'=>'lesson_type_other','class' => (isset($postMetaArray['lesson_type']) && in_array("other", @$postMetaArray['lesson_type'])) ? 'form-control other_box_visible' : 'form-control other_box','placeholder' => 'Enter Other']) }}
               ...
               <div class="form-group col-xl-12 col-md-12 col-sm-12">
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      {{ Form::label('where_do_you_do_that', __('web.helpers.where_do_you_do_that').':') }}
                      ...
                      'online'=>'Online',
                      'other'=>'Other']
                      , @$postMetaArray['where_do_you_do_that'], ['id'=>'where_do_you_do_that','class' => 'form-control select-box select_box_other_multiple','multiple']) }}

                     {{ Form::text('where_do_you_do_that_other',@$postMetaArray['where_do_you_do_that_other'], ['id'=>'where_do_you_do_that_other','class' => (isset($postMetaArray['where_do_you_do_that']) && in_array("other", @$postMetaArray['where_do_you_do_that'])) ? 'form-control other_box_visible' : 'form-control other_box','placeholder' => 'Enter Other']) }}
               ...
               <div class="form-group col-xl-12 col-md-12 col-sm-12">
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      {{ Form::label('music_style', __('web.helpers.music_style').':') }}
                      ...
                      'other'=>'Other']
                      , @$postMetaArray['music_style'], ['id'=>'music_style','class' => 'form-control select-box select_box_other_multiple','multiple']) }}
                       {{ Form::text('music_style_other',@$postMetaArray['music_style_other'], ['id'=>'music_style_other','class' => (isset($postMetaArray['music_style']) && in_array("other", @$postMetaArray['music_style'])) ? 'form-control other_box_visible' : 'form-control other_box','placeholder' => 'Enter Other']) }}
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('age_group', __('web.helpers.what_age_group_do_you_want_to_teach').':') }}<span class="text-danger">*</span>
                      {{ Form::select('age_group',
                      ['upto12years' =>'Up to 12 years' , '12-17years' =>'12 to 17 years)' ,'18yearandolder'=>'18 year and older']
                      ,@$postMetaArray['age_group'], ['id'=>'age_group','class' => 'form-control select-box required','placeholder'=>'Select age group']) }}
                </div></div>
...
<div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    {{ Form::label('do_you_have_tools', __('web.helpers.do_you_have_your_own_tools_supplie').':') }}<span class="text-danger">*</span><br>
                    {{ Form::radio('do_you_have_tools', '1',isset($postMetaArray['do_you_have_tools']) && $postMetaArray['do_you_have_tools'] ==1 ? true: false)  ,['class' => 'form-control check-box']}} {{ __('web.helpers.yes') }}
                &nbsp;&nbsp;&nbsp;
                {{ Form::radio('do_you_have_tools', '0',isset($postMetaArray['do_you_have_tools']) && $postMetaArray['do_you_have_tools'] ==0 ? true: false),[ 'class' => 'form-control check-box'] }} {{ __('web.helpers.no') }}

                <div class="radio_yes_box" id="do_you_have_tools_box" style="display:none">


                      {{ Form::label('do_you_have_tools_text', __('web.helpers.which_one').':') }}<span class="text-danger">*</span><br>
                      {{ Form::text('do_you_have_tools_text', @$postMetaArray['do_you_have_tools_text'], ['class' => 'form-control']) }}
        ...
        <div class="form-group col-xl-6 col-md-6 col-sm-6">
         ...
         {{ Form::label('passport_back_later', __("web.helpers.copy_passport_later")) }}
          ...
          <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  ...
                  ['id'=>'highest_education','class' => 'form-control select-box select_box_other required','required','placeholder' => 'Select Highest Education']) }}
                  {{ Form::text('highest_education_other', @$postMetaArray['highest_education_other'], ['id'=>'highest_education_other','class' => (isset($postMetaArray['highest_education']) && $postMetaArray['highest_education']=="other") ? 'form-control other_box_visible' : 'form-control other_box','placeholder'=>'Enter Other']) }}
       ...
       <div class="row">
        ...
        <div class="row">
         ...
         <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  ...
                  'other'=>'Other']
                  , @$postMetaArray['character_traits'], ['id'=>'character_traits','class' => 'form-control select-box required select_box_other_multiple','multiple']) }}
        ...
        <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  ...
                  {{ Form::select('available_for[]',
                    ['vast'  => 'Vast',
                               ...
                               'sometimes'  => 'Sometimes',
                               'other'  => 'Other']
                  ,@$postMetaArray['available_for'], ['id'=>'available_for','class' => 'form-control select-box required select_box_other_multiple','multiple']) }}
