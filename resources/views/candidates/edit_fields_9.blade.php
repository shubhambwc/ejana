    ...
    <div class="row tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                 <div id="message3">{{__("web.helpers.helpers_experience_as_a")}} {{$JobCategoryDetail->name}}? <br>
                 </div>
            </div>
                <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,@$postMetaArray['exprience'], ['id'=>'helpers_exprience','class' => 'form-control select-box required','required','placeholder' => 'How many years of experience do you have with elderly care?']) }}
                </div>
                </div>
             ...
             <div class="row">
               ...
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      {{ Form::label('extra_offer', __('web.helpers.extra_offer').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="You provide light support and companionship to the elderly. It is always about light care tasks care performed by professional caregivers. like:">?</a>
...
<div class="row">
          ...
          <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 ...
                 <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    {{ Form::label('which_direction', __('web.helpers.which_direction').':') }}<span class="text-danger">*</span>
                    {{ Form::text('which_direction', @$postMetaArray['which_direction'], ['class' => 'form-control required']) }}
                </div>
               </div>
                ...
                {{ Form::radio('do_smoke', '1',isset($postMetaArray['do_smoke']) && $postMetaArray['do_smoke'] ==1 ? true: false),['class' => 'form-control check-box required']}} {{ __('web.helpers.yes') }}
                &nbsp;&nbsp;&nbsp;
                {{ Form::radio('do_smoke', '0',isset($postMetaArray['do_smoke']) && $postMetaArray['do_smoke'] ==0 ? true: false),['class' => 'form-control check-box required'] }} {{ __('web.helpers.no') }}
                  </div>
