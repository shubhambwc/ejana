    ...
    <div class="row tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,@$postMetaArray['exprience'], ['id'=>'helpers_exprience','class' => 'form-control select-box required','required','placeholder' => 'How many years of experience do you have as a handyman?']) }}
                </div>
                </div>
 ...
 <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                     {{ Form::label('extra_offer', __('web.helpers.what_are_you_offering').':') }}<span class="text-danger">*</span>

                        {{ Form::select('extra_offer[]',
                        ['Plumbing_Masonry' =>'Plumbing Masonry',
                        'Paint' =>'Paint',
                        'Stucco' =>'Stucco',
                        'Wallpaper' =>'Wallpaper',
