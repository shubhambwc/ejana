    ...
    <div class="row tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,@$postMetaArray['exprience'], ['id'=>'helpers_exprience','class' => 'form-control select-box required','required','placeholder' => 'How many years of experience do you have as a garden helper?']) }}
                </div>
                </div>
...
<div class="row">
             ...
             <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 <p><b>{{ __('web.helpers.activities')  }}:</b></p>
               </div>
               </div>
               ...
               <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 ...
                 <p><input type="checkbox" name="extra_offer_light[]" value="Watering plants and flour" <?php if (isset($postMetaArray['extra_offer_light']) && in_array("Watering plants and flour", @$postMetaArray['extra_offer_light'])){ echo 'checked';}else{ echo '';}?> > Watering plants and flour</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Sowing plants" <?php if (isset($postMetaArray['extra_offer_light']) && in_array("Sowing plants", @$postMetaArray['extra_offer_light'])){ echo 'checked';}else{ echo '';}?> > Sowing plants</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Removing weeds" <?php if (isset($postMetaArray['extra_offer_light']) && in_array("Removing weeds", @$postMetaArray['extra_offer_light'])){ echo 'checked';}else{ echo '';}?> > Removing weeds</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Grasmaaien" <?php if (isset($postMetaArray['extra_offer_light']) && in_array("Grasmaaien", @$postMetaArray['extra_offer_light'])){ echo 'checked';}else{ echo '';}?> > Grasmaaien</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Sweep" <?php if (isset($postMetaArray['extra_offer_light']) && in_array("Sweep", @$postMetaArray['extra_offer_light'])){ echo 'checked';}else{ echo '';}?> > Sweep</p>
                  <p><input type="checkbox" name="extra_offer_light[]" value="Pruning, trimming and/or felling" <?php if (isset($postMetaArray['extra_offer_light']) && in_array("Pruning, trimming and/or felling", @$postMetaArray['extra_offer_light'])){ echo 'checked';}else{ echo '';}?> > Pruning, trimming and/or felling</p>
                 ...
                 <p><input type="checkbox" name="extra_offer_light[]" value="Pond cleaning" <?php if (isset($postMetaArray['extra_offer_light']) && in_array("Pond cleaning", @$postMetaArray['extra_offer_light'])){ echo 'checked';}else{ echo '';}?> > Pond cleaning</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Cleaing terrace/ tiles/ garden furniture" <?php if (isset($postMetaArray['extra_offer_light']) && in_array("Cleaing terrace/ tiles/ garden furniture", @$postMetaArray['extra_offer_light'])){ echo 'checked';}else{ echo '';}?> > Cleaing terrace/ tiles/ garden furniture</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Cleaning up the barn" <?php if (isset($postMetaArray['extra_offer_light']) && in_array("Cleaning up the barn", @$postMetaArray['extra_offer_light'])){ echo 'checked';}else{ echo '';}?> > Cleaning up the barn</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Remainder" <?php if (isset($postMetaArray['extra_offer_light']) && in_array("Remainder", @$postMetaArray['extra_offer_light'])){ echo 'checked';}else{ echo '';}?> > Remainder</p>
                 <p><input  id="extra_offer_heavy_other_value" type="checkbox" name="extra_offer_light[]" value="Other" <?php if (isset($postMetaArray['extra_offer_light']) && in_array("Other", @$postMetaArray['extra_offer_light'])){ echo 'checked';}else{ echo '';}?> > Other</p>
                  <p>
            ...
            <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    {{ Form::label('do_you_have_gardentools', __('web.helpers.do_you_have_your_own_gardentools').':') }}<span class="text-danger">*</span><br>
                    {{ Form::radio('do_you_have_gardentools', '1',isset($postMetaArray['do_you_have_gardentools']) && $postMetaArray['do_you_have_gardentools'] ==1 ? "checked":"")  ,['class' => 'form-control check-box']}} {{ __('web.helpers.yes') }}
                        &nbsp;&nbsp;&nbsp;
                    {{ Form::radio('do_you_have_gardentools', '0',isset($postMetaArray['do_you_have_gardentools']) && $postMetaArray['do_you_have_gardentools'] == 0? "checked":""),[ 'class' => 'form-control check-box'] }} {{ __('web.helpers.no') }}

                   <div class="radio_yes_box" id="do_you_have_gardentools_box" style="display:<?php if(isset($postMetaArray['do_you_have_gardentools']) && $postMetaArray['do_you_have_gardentools'] ==1){ echo 'block';}else{ echo 'none';}?>">


                      {{ Form::label('gardentools', __('web.helpers.which_one').':') }}<br>
                      {{ Form::text('gardentools', @$postMetaArray['gardentools'], ['class' => 'form-control']) }}
    ...
    <div class="row tabcontent pt-1 disable" id="tab5">
      ...
      <div class="row">
         ...
         <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  {{ Form::label('allergic_of_cleaning_means', __('web.helpers.are_you_allergic_to_certain_cleaning_means')) }}<span class="text-danger">*</span>
                  {{ Form::text('allergic_of_cleaning_means', @$postMetaArray['allergic_of_cleaning_means'], ['class' => 'form-control required']) }}
        </div>
        </div>
