...
@section('content')
    ...
    maxDate: new Date()
        ...
        $("#AddNewLang").click(function(){
         ...
         var newLangHtml = '<div class="additional_lang_row" id="add_lang'+addLang+'"> <div class="form-group col-xl-6 col-md-6 col-sm-12"><label for="lang_name">Add Other langauge</label>';
         newLangHtml +='<input class="form-control" name="Other_lang['+addLang+'][name]" type="text">';
         newLangHtml +='</div>';     
         newLangHtml +='<div class="form-group col-xl-6 col-md-6 col-sm-12">';
         newLangHtml +='<input class="form-control" name="Other_lang['+addLang+'][level]" type="select">';
         newLangHtml +='</div>'; 
         newLangHtml +='<a id="'+addLang+'" href="javascript:void(0)" class="btn btn-primary remove-lang" >Remove Langauge</a>';
         newLangHtml +='</div></div>';
