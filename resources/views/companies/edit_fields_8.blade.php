<div class="row  tabcontent active pt-1" id="tab1">
    ...
    <div class="row tabcontent pt-1 disable" id="tab2">
            <div class="custom-form">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,@$postMetaArray['type_of_assistance'], ['id'=>'type_of_assistance','class' => 'form-control select-box required','multiple']) }}
 ...
 <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,@$postMetaArray['type_of_device_need'], ['id'=>'type_of_device_need','class' => 'form-control select-box select_box_other','placeholder' => 'Select device']) }}
                      {{ Form::text('type_of_device_need_other', @$postMetaArray['type_of_device_need_other'], ['id'=>'type_of_device_need_other','class' => 'form-control other_box','placeholder' => 'Enter other']) }}
                 ...
                 <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,@$postMetaArray['operating_systems_need'], ['id'=>'operating_systems_need','class' => 'form-control select-box select_box_other','placeholder' => 'Select OS']) }}
                     {{ Form::text('operating_systems_need_other', @$postMetaArray['operating_systems_need_other'], ['id'=>'operating_systems_need_other','class' => 'form-control other_box','placeholder' => 'Enter other']) }}
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    ...
                    {{ Form::radio('have_tools_supplies', '1',false),['class' => 'form-control check-box required']}} {{ __('web.helpers.yes') }}
                    &nbsp;&nbsp;&nbsp;
                    {{ Form::radio('have_tools_supplies', '0',true),['class' => 'form-control check-box required'] }} {{ __('web.helpers.no') }}
