   ...
   <div class="row">
    ...
    <div class="row tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('date_childcare_need', __('web.helpers.when_do_you_need_childcare').':') }}<span class="text-danger">*</span>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('opvanglocatie', __('web.helpers.opvanglocatie').':') }}<span class="text-danger">*</span>
                      {{ Form::select('opvanglocatie[]',
                      ['Eigenhuis' =>'Eigenhuis' ,
                      'With the childminder' =>'With the childminder' ,
                      'No preference'=>'No preference',
                      ]
                      ,@$postMetaArray['opvanglocatie'], ['id'=>'opvanglocatie','class' => 'form-control select-box required','multiple']) }}
                </div>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,@$postMetaArray['type_of_care'], ['id'=>'type_of_care','class' => 'form-control select-box select_box_other_multiple required']) }}
           ...
           <div class="custom-form">
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      {{ Form::textarea('remarks', @$postMetaArray['remark'], ['class' => 'form-control','row'=>'5']) }}
                </div>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                     ...
                     'other'=>'Other animal',
                     'no'=>'No']
                      ,@$postMetaArray['have_pets'], ['id'=>'have_pets','class' => 'form-control select-box select_box_other_multiple','multiple']) }}
                      {{ Form::text('have_pets_other', @$postMetaArray['have_pets_other'], ['id'=>'have_pets_other','class' => (isset($postMetaArray['have_pets']) && in_array("other", @$postMetaArray['have_pets'])) ? 'form-control other_box_visible' : 'form-control other_box','placeholder'=>'Enter other']) }}
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('objection_width_childminder', __('web.helpers.objection_to_pets_with_the_childminder').':') }}<span class="text-danger">*</span>
                      {{ Form::textarea('objection_width_childminder', @$postMetaArray['objection_width_childminder'], ['class' => 'form-control required','row'=>'5']) }}
                </div>
