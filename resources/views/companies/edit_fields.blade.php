                ...
                <div class="w-100">
                    <div class="text-left employee-data text-limit">
                        <span class="text-decoration-none text-color-gray">
                            <a href="{{ route('company.index') }}/{{ $company->id }}/edit?service_id={{$jobCategory->id}}" class="show-btn">
                    ...
                    <div class="text-left employee-date mt-2">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="employee-label ml-1">{{ __('Is Service Active') }}</span>
                        </label>
                        <?php
...
<!-- Tab 4 -->
      <div class="row section_tab" id="section_tab4">
                <div class="card" style="width:100%"> 
                                <div class="card-body">
                @include('companies.transaction.table')
...
<!-- Tab 5 -->
      <div class="row section_tab" id="section_tab5">
                <div class="card" style="width:100%"> 
                                <div class="card-body">
                @include('companies.job_application.table')
