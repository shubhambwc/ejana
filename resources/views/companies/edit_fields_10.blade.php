           ...
           <div class="custom-form">
             ...
             <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                    ...
                    {{ Form::text('mean_of_transport_other', @$postMetaArray['other'], ['id'=>'mean_of_transport_other','class' => 'form-control other_box','placeholder'=>'Enter other']) }}
                ...
                <div class="row" id="child_transport_box" style="display:none">
                   ...
                   <div class="form-group col-xl-6 col-md-6 col-sm-12">
                        ...
                        {{ Form::radio('child_pickup', '1',isset($postMetaArray['child_pickup']) && $postMetaArray['child_pickup'] ==1 ?"checked":"") ,['class' => 'form-control check-box']}} {{ __('web.helpers.yes') }}
                        &nbsp;&nbsp;&nbsp;

                        {{ Form::radio('child_pickup', '0',isset($postMetaArray['child_pickup']) && $postMetaArray['child_pickup'] ==0 ?"checked":""),['class' => 'form-control check-box'] }} {{ __('web.helpers.no') }}<br>
                      ...
                      ,@$postMetaArray['child_bring_to'], ['id'=>'child_bring_to','class' => 'form-control select-box','multiple']) }}
                        ...
                        {{ Form::text('child_bring_to_other', @$postMetaArray['child_bring_to_other'], ['id'=>'child_bring_to_other','class' => 'form-control other_box','placeholder'=>'Enter other']) }}
                  ...
                  <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      {{ Form::radio('child_bring', '1',isset($postMetaArray['child_bring']) && $postMetaArray['child_bring'] ==1 ?"checked":"") ,['class' => 'form-control check-box']}} {{ __('web.helpers.yes') }}
                        &nbsp;&nbsp;&nbsp;
                      {{ Form::radio('child_bring', '0',isset($postMetaArray['child_bring']) && $postMetaArray['child_bring'] ==0 ?"checked":""),['class' => 'form-control check-box'] }} {{ __('web.helpers.no') }}<br>
                    ...
                    <div id="child_bring_from_box" style="display:none">
                      ...
                      {{ Form::text('child_bring_from_other', @$postMetaArray['child_bring_from_other'], ['id'=>'child_bring_from_other','class' => 'form-control other_box','placeholder'=>'Enter other']) }}
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 ...
                 <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  ...
                  <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      {{ Form::text('other_option_other', @$postMetaArray['other_option_other'], ['id'=>'other_option_other','class' => 'form-control other_box','placeholder'=>'Enter other']) }}
                  </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    {{ Form::label('offer_extra', __('Offers you something extra').':') }}<span class="text-danger">*</span></br>
                    {{ Form::text('offer_extra', @$postMetaArray['offer_extra'], ['id'=>'offer_extra','class' => 'form-control']) }}
                </div>
             </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    {{ Form::label('have_tools_supplies', __('Do you have all the tools/supplies yourself').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="Do you have your own trailer or items bellow">?</a><span class="text-danger">*</span></br>
             ...
             <div class="row" id="have_tools_supplies_yes" style="display:none">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    {{ Form::label('like_what', __('What tools').':') }}<span class="text-danger">*</span></br>
                    {{ Form::text('like_what', @$postMetaArray['like_what'], ['id'=>'like_what','class' => 'form-control']) }}
                </div>
             </div>
