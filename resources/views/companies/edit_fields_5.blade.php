   ...
   <div class="row">
    ...
    <div class="row tabcontent pt-1 disable" id="tab2">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('date_need', __('web.helpers.when_do_you_need_garden_help').'?:') }}<span class="text-danger">*</span>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('type_of_garden_help', __('web.helpers.type_of_garden_help').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="One-off, Fixed days, Flexible days">?</a><span class="text-danger">*</span>
                ...
                {{ Form::text('type_of_garden_help_other', @$postMetaArray['type_of_garden_help_other'], ['id'=>'type_of_garden_help_other','class' => (isset($postMetaArray['type_of_garden_help']) && $postMetaArray['type_of_garden_help']== "other") ? 'form-control other_box_visible' : 'form-control other_box','placeholder'=>'Enter Other']) }}
    ...
    <div class="row tabcontent pt-1 disable" id="tab3">
           ...
           <div class="custom-form">
             ...
             <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('garden_area', __('web.helpers.garden_area').':') }}<span class="text-danger">*</span>
                      {{ Form::select('garden_area',
                     ['< 30m2' =>'< 30m2' ,
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('activities', __('Activities').':') }}<span class="text-danger">*</span>
                </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  {{ Form::checkbox('activities[]', 'Watering plants and flour', (isset($postMetaArray['activities']) && in_array("Watering plants and flour", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Watering plants and flour')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Sowing plants', (isset($postMetaArray['activities']) && in_array("Sowing plants", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Sowing plants')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Removing weeds', (isset($postMetaArray['activities']) && in_array("Removing weeds", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Removing weeds')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Grasmaaien', (isset($postMetaArray['activities']) && in_array("Grasmaaien", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Grasmaaien')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Sweep', (isset($postMetaArray['activities']) && in_array("Sweep", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Sweep')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Pruning, trimming and/or felling', (isset($postMetaArray['activities']) && in_array("Pruning, trimming and/or felling", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Pruning, trimming and/or felling')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Pond cleaning', (isset($postMetaArray['activities']) && in_array("Pond cleaning", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Pond cleaning')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Cleaning terrace/tiles/garden furniture', (isset($postMetaArray['activities']) && in_array("Cleaning terrace/tiles/garden furniture", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Cleaning terrace/tiles/garden furniture')) }}
                  </p>
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  {{ Form::checkbox('activities[]', 'Cleaning up the barn', (isset($postMetaArray['activities']) && in_array("Cleaning up the barn", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Cleaning up the barn')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Remainder', (isset($postMetaArray['activities']) && in_array("Remainder", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Remainder')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Placing fence, disassembling', (isset($postMetaArray['activities']) && in_array("Placing fence, disassembling", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Placing fence, disassembling')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Shoveling away sand/clay', (isset($postMetaArray['activities']) && in_array("Shoveling away sand/clay", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Shoveling away sand/clay')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Tilling/paving', (isset($postMetaArray['activities']) && in_array("Tilling/paving", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Tilling/paving')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Placing/removing the pond', (isset($postMetaArray['activities']) && in_array("Placing/removing the pond", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Placing/removing the pond')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'In construction with the helper', (isset($postMetaArray['activities']) && in_array("In construction with the helper", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('In construction with the helper')) }}
                  </p>
                  <p>
                  <input name="activities[]" type="checkbox" value="other" class="activities_other_name">
                  {{ Form::label('activities[]', 'Other', (isset($postMetaArray['activities']) && in_array("Other", $postMetaArray['activities'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  </p>
                </div>
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 {{ Form::text('activities_other', @$postMetaArray['activities_other'], ['id'=>'activities_other','class' => 'form-control other_box','placeholder'=>'Enter Other']) }}
                </div>
             ...
             <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    ...
                    {{ Form::radio('have_tool_supplies', '1',isset($postMetaArray['have_tool_supplies']) && $postMetaArray['have_tool_supplies'] ==1 ? true:false),['class' => 'form-control check-box required']}} {{ __('web.helpers.yes') }}
                    &nbsp;&nbsp;&nbsp;
                    {{ Form::radio('have_tool_supplies', '0',isset($postMetaArray['have_tool_supplies']) && $postMetaArray['have_tool_supplies'] ==0 ? true:false),['class' => 'form-control check-box required'] }} {{ __('web.helpers.no') }}
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('remark', __('web.helpers.comments').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="Do you have any comments that are important to the gardner, for example: prefer not to smoke or rather someone who is not afraid of animals.">?</a><span class="text-danger">*</span>
                      {{ Form::textarea('remark', @$postMetaArray['remark'], ['class' => 'form-control required','row'=>'5','placeholder'=>"E.g.: Beware! We have 2 big dogs it's just about the backyard."]) }}
                </div>
