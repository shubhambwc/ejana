   ...
   <div class="row">
    ...
    <div class="row tabcontent pt-1 disable" id="tab2">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('date_need', __('web.helpers.when_do_you_need_domestic_help?').':') }}<span class="text-danger">*</span>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('type_of_help', __('web.helpers.type_of_domestic_help').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="One-off, Fixed days, Flexible days">?</a><span class="text-danger">*</span>
                      ...
                      ,@$postMetaArray['type_of_help'], ['id'=>'type_of_help','class' => 'form-control select-box select_box_other_multiple','multiple']) }}
                {{ Form::text('type_of_help_other',@$postMetaArray['type_of_help_other'], ['id'=>'type_of_help_other','class' => (isset($postMetaArray['type_of_help']) && in_array("other", @$postMetaArray['type_of_help'])) ? 'form-control other_box_visible' : 'form-control other_box','placeholder' => 'Enter Other']) }}
    ...
    <div class="row tabcontent pt-1 disable" id="tab3">
           ...
           <div class="custom-form">
             ...
             <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('type_of_property', __('web.helpers.type_of_property').':') }}<span class="text-danger">*</span>
                      {{ Form::select('type_of_property',
                     ['Apartment'=>'Apartment',
                     'farmVrijstaande2'=>'farmVrijstaande2',
                     'kaprijtjeshuisanders'=>'kaprijtjeshuisanders',
                      'other'=>'Other'
                     ]
                      ,@$postMetaArray['type_of_property'], ['id'=>'type_of_property','class' => 'form-control select-box select_box_other','placeholder'=>'What type of home do you live in?']) }}
                        {{ Form::text('type_of_property_other', @$postMetaArray['type_of_property_other'], ['id'=>'type_of_property_other','class' => (isset($postMetaArray['type_of_property']) && $postMetaArray['type_of_property'] == 'other') ? 'form-control other_box_visible' : 'form-control other_box','placeholder'=>'Enter Other']) }}
                </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('your_living_area', __('web.helpers.how_much_is_your_living_area').':') }}<span class="text-danger">*</span>
                      {{ Form::select('your_living_area',
                      ['< 30' =>'< 30m2',
                      '30-80' =>'30 to 80m2',
                      '80-120'=>'80 t0 120m2',
                      '120-250'=>'120-250m2',
                      '> 250'=>'250m2 and large',
                      'other'=>'Other']
                      ,@$postMetaArray['your_living_area'], ['id'=>'your_living_area','class' => 'form-control select-box select_box_other','placeholder'=>'How much is your living area']) }}
                {{ Form::text('your_living_area_other', @$postMetaArray['your_living_area_other'], ['id'=>'your_living_area_other','class' => (isset($postMetaArray['your_living_area']) && $postMetaArray['your_living_area'] == 'other') ? 'form-control other_box_visible' : 'form-control other_box','placeholder'=>'Enter Other']) }}
                </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('room_to_be_cleaned', __('web.helpers.what_room_do_you_want_to_have_cleaned').':') }}<span class="text-danger">*</span>
                      {{ Form::select('room_to_be_cleaned',
                     ['bathrooms and toilet' =>'Bathrooms and toilet',
                      'kitchen' =>'kitchen',
                      'living and bedroom'=>'living and bedroom',
                      'floor kick Entree/hal/gang'=>'floor kick Entree/hal/gang',
                      'Front door'=>'Front door',
                      'back door and balcony'=>'back door and balcony',
                      'Glass washing'=>'Glass washing',
                      'inside Berging'=>'inside Berging',
                      'schuren/of garag'=>'schuren/of garag',
                      'other'=>'Other'
                      ]
                      ,@$postMetaArray['room_to_be_cleaned'], ['id'=>'room_to_be_cleaned','class' => 'form-control select-box select_box_other','placeholder'=>'What room do you want to have cleaned']) }}
                {{ Form::text('room_to_be_cleaned_other', @$postMetaArray['room_to_be_cleaned_other'], ['id'=>'room_to_be_cleaned_other','class' => (isset($postMetaArray['room_to_be_cleaned']) && $postMetaArray['room_to_be_cleaned'] == 'other') ? 'form-control other_box_visible' : 'form-control other_box','placeholder'=>'Enter Other']) }}
                </div>
            </div>
             ...
             <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('preference', __('web.helpers.preference').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="Advice: You need to make sure that the helper can work safely, So: a stable cleaning ledder, do not leave on a ladder, work gloves etc. If you do not do this and something happens, you are liable for the personal injury of the helper.">?</a><span class="text-danger">*</span>
            ...
            <div class="row">
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
               <p><b>{{ __('web.helpers.household_leaning_task') }}:</b></p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  {{ Form::checkbox('preference[]', 'Tidy up',  (isset($postMetaArray['preference']) && in_array("Tidy up", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Tidy up')) }}
                  </p>

                  <p>
                  {{ Form::checkbox('preference[]', 'Dust removal', (isset($postMetaArray['preference']) && in_array("Dust removal", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Dust removal')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Make up the bed(s)', (isset($postMetaArray['preference']) && in_array("Make up the bed(s)", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Make up the bed(s)')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Cleaning and washing up', (isset($postMetaArray['preference']) && in_array("Cleaning and washing up", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Cleaning and washing up')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Watering plants', (isset($postMetaArray['preference']) && in_array("Watering plants", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Watering plants')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Cook', (isset($postMetaArray['preference']) && in_array("Cook", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Cook')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Vacuum', (isset($postMetaArray['preference']) && in_array("Vacuum", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Vacuum')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Mop', (isset($postMetaArray['preference']) && in_array("Mop", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Mop')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('preference[]', 'Scrubbing rooms/sanitary/kitchan', (isset($postMetaArray['preference']) && in_array("Scrubbing rooms/sanitary/kitchan", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Scrubbing rooms/sanitary/kitchan')) }}
                  </p>
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                   <p>
                  {{ Form::checkbox('preference[]', 'Changing beds', (isset($postMetaArray['preference']) && in_array("Changing beds", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Changing beds')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Taking out he trash', (isset($postMetaArray['preference']) && in_array("Taking out he trash", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Taking out he trash')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Washing, drying and ironing', (isset($postMetaArray['preference']) && in_array("Washing, drying and ironing", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Washing, drying and ironing')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Window patching', (isset($postMetaArray['preference']) && in_array("Window patching", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Window patching')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Removing doors', (isset($postMetaArray['preference']) && in_array("Removing doors", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Removing doors')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Shopping', (isset($postMetaArray['preference']) && in_array("Shopping", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Shopping')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'In construction with requestor', (isset($postMetaArray['preference']) && in_array("In construction with requestor", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('In construction with requestor')) }}
                  </p>
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 {{ Form::text('preference_other', @$postMetaArray['preference_other'], ['id'=>'preference_other','class' => 'form-control other_box','placeholder'=>'Enter Other']) }}
                </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  {{ Form::checkbox('the_greate_cleaning', 'The Greate Cleaning', (isset($postMetaArray['the_greate_cleaning']) && $postMetaArray['the_greate_cleaning'] == 'The Greate Cleaning') ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('the_greate_cleaning', __('The Greate Cleaning')) }}
                  </p>
                </div>
