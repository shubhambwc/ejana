   ...
   <div class="row">
    ...
    <div class="row tabcontent pt-1 disable" id="tab2">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('date_need', __('When do you need animal sitters?').':') }}<span class="text-danger">*</span>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('type_of_help', __('Type of animal sitter help').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="One-off, Fixed days, Flexible days">?</a><span class="text-danger">*</span>
    ...
    <div class="row tabcontent pt-1 disable" id="tab3">
           ...
           <div class="custom-form">
             ...
             <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('pet_involved', __('Which pet(s) are involved?').':') }}<span class="text-danger">*</span>
                      {{ Form::select('pet_involved[]',
                     ['dogs'=>'Dogs',
                     'cat'=>'Cat',
                     'Rabbit(s) and rodents'=>'Rabbit(s) and rodents',
                     'Birds'=>'Birds',
                     'other'=>'Other']
                      ,@$postMetaArray['pet_involved'], ['id'=>'pet_involved','class' => 'form-control select-box','multiple']) }}

                      {{ Form::text('pet_involved_other', null, ['id'=>'pet_involved_other','class' => 'form-control other_box','placeholder' => 'Enter other']) }}
             ...
             <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('number_of_pets', __('Number of pets').':') }}<span class="text-danger">*</span>
                      {{ Form::text('number_of_pets', @$postMetaArray['number_of_pets'], ['class' => 'form-control required']) }}
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('preference', __('Preference').':') }}<span class="text-danger">*</span>
                  <p>
                  {{ Form::checkbox('preference[]', 'Caring for animals in their own home', (isset($postMetaArray['preference']) && in_array("Caring for animals in their own home", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Caring for animals in their own home')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Caring for animals in your own home', (isset($postMetaArray['preference']) && in_array("Caring for animals in your own home", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Caring for animals in your own home')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'other', (isset($postMetaArray['preference']) && in_array("other", $postMetaArray['preference'])) ? true:false) ,['class' => 'form-control check-box'] }}
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('what_needs_to_be_done', __('Tasks for the animal sitter').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="What should the helpers do?">?</a><span class="text-danger">*</span>
                      {{ Form::textarea('what_needs_to_be_done', @$postMetaArray['what_needs_to_be_done'], ['class' => 'form-control required','row'=>'5','placeholder'=>"E.g. walking the dog twice a day, feedingand drinking and cleaning the Litter Box"]) }}
                </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('remark', __('Comments').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="Do you have any comments that are important for the heloper, the dogs cant run loose">?</a><span class="text-danger">*</span>
