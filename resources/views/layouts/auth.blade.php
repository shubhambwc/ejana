...
<head>
    ...
    <title>@yield('title') | Ejana</title><!--     <title>@yield('title') | {{ config('app.name') }}</title> -->
                ...
                <div class="col-md-6 offset-md-3">
                    <div class="login-brand">
                        <img src="{{ getSettingValue('logo') }}" alt="logo" width="100"
                             class="shadow-light">  
                            <!--  <img src="{{ asset('assets/img/Logo_jn.png') }} " alt="logo" width="100"
                             class="shadow-light"> -->
                    </div>
                    @yield('content')
...
<!-- General JS Scripts -->
<script id="2" src="{{ secure_asset('assets/js/jquery.min.js') }}"></script>
...
<!-- Template JS File -->
<script src="{{ secure_asset('web/backend/js/stisla.js') }}"></script>
<script src="{{ secure_asset('web/backend/js/scripts.js') }}"></script>
