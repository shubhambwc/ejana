<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu mt-3">
      ...
      <ul class="sidebar-menu mt-3">
       <ul class="sidebar-menu ">
            <li class="side-menus {{ Request::is('admin/help-requester*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('company.index') }}"><i class="fas fa-user-tie"></i>
                    <span>{{ __('messages.help_requester') }}</span></a></li>
      </ul>

      <ul class="sidebar-menu mt-3">
       <ul class="sidebar-menu ">
            <li class="side-menus {{ Request::is('admin/helper*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('candidates.index') }}"><i class="fas fa-users"></i>
                    <span>{{ __('messages.helpers') }}</span></a></li>
      </ul>

      <ul class="sidebar-menu mt-3">
       <ul class="sidebar-menu ">
            <li class="side-menus {{ Request::is('admin/services*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('job-categories.index') }}"><i class="fas fa-sitemap"></i>
                    <span>{{ __('messages.services') }}</span></a></li>
      </ul>
       ...
       <ul class="sidebar-menu ">
            <li class="side-menus {{ Request::is('admin/services*') ? 'active' : '' }}">
                <a class="nav-link" href="#"><i class="fas fa-money-bill"></i>
                    <span>{{ __('messages.financial') }}</span></a></li>
      </ul> -->
       ...
       <ul class="sidebar-menu ">
            <li class="side-menus {{ Request::is('admin/services*') ? 'active' : '' }}">
                <a class="nav-link" href="#"><i class="fas fa-list-alt"></i>
                    <span>{{ __('messages.reports') }}</span></a></li>
      </ul> -->
     <!--  <ul class="sidebar-menu mt-3">
       <ul class="sidebar-menu ">
            <li class="side-menus {{ Request::is('admin/services*') ? 'active' : '' }}">
                <a class="nav-link" href="#"><i class="fa fa-cog"></i>
                    <span>{{ __('messages.management') }}</span></a></li>
      </ul> -->
            ...
            <ul class="dropdown-menu side-menus">
               ...
               <!--  <li class="side-menus {{ Request::is('admin/reported-company*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('reported.companies') }}">
                        ...
                        <span> {{ __('ReportedHelp Requester') }}</span>
                    </a>
                </li> -->
            <!-- </ul>
        </li>
            ...
            <!--     <li class="side-menus {{ Request::is('admin/required-degree-level*') ? 'active' : '' }}">
               ...
               <!--  <li class="side-menus {{ Request::is('admin/reported-candidate*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('reported.candidates') }}">
                        <i class="fas fa-file-signature"></i>
                        <span>{{ __('messages.candidate.reported_Helper') }}</span>
                    </a>
                </li>
 -->              
  ...
  <!--       <li class="nav-item side-menus dropdown">
        ...
        <ul class="sidebar-menu mt-3">
       <ul class="sidebar-menu ">
            <li class="side-menus {{ Request::is('admin/moments*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('moments.index') }}"><i class="fas fa-bell"></i>
                    <span>{{ __('web.helpers.contact_moments') }}</span></a></li>
      </ul>
      <ul class="sidebar-menu ">
            <li class="side-menus {{ Request::is('admin/job-applications*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('jobs.applications') }}"><i class="fa fa-briefcase"></i>
                    <span>{{ __('web.helpers.job_applications') }}</span></a></li>
      </ul>
       <!--
        <li class="side-menus {{ Request::is('admin/subscribers*') ? 'active' : '' }}">
            ...
            <li class="side-menus {{ Request::is('admin/complaints*') ? 'active' : '' }}">
            ...
            <!--<li class="side-menus {{ Request::is('admin/email-templates*') ? 'active' : '' }}">
...
<script id="1" src="{{ secure_asset('assets/js/jquery.min.js') }}"></script>
