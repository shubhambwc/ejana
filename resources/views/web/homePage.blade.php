...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link rel="stylesheet" href="assets/assets/css/bootstrap.min.css" type="text/css">

    <!--Material Icon -->
    <link rel="stylesheet" type="text/css" href="assets/assets/css/materialdesignicons.min.css" />

    <link rel="stylesheet" type="text/css" href="assets/assets/css/fontawesome.css" />
    <link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Lato" />

    <!-- selectize css -->
    <link rel="stylesheet" type="text/css" href="assets/assets/css/selectize.css" />
        ...
        <div class="container">
            ...
            <div>
                <a href="index.html" class="logo">
                    <img src="assets/assets/images/logo-dark.png" alt="" class="logo-light" height="50" />
                    <img src="assets/assets/images/logo-dark.png" alt="" class="logo-dark" height="50" />
                </a>
            </div>                 
...
<div class="col-lg-3 col-md-6 mt-4 pt-2 line">
                ...
                </div><div class="col-lg-3 col-md-6 mt-4 pt-2 line">
...
<div class="col-12">
                                ...
                                <div class="bg-light11 "><h6 align="center" class="f-18 pt-1">   $20.00/hr
                                ...
                                <p align="center" class="text-muted small mb-0">(42 times worked)</p>
                                 <p align="center"  class="text-muted  small mb-0"><a href="#">VIEW PROFILE</a></p>
                                  <div align="center" ><a href="#" class="btn btn-primary btn-sm ">SELECT</a></div></div>

                             
                                </div></div>
                                 <div class="testi-icon">
                                <div class="bg-light1 "><h6 align="center" class="f-18 pt-1">   $20.00/hr
...
<div align="center">Read our current covid-19 policy and the adjusted guidelines, based on the measures of the government and relevant health authorities.</div>
                ...
                <div class="col-lg-3 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <p class="text-white1 mb-4 footer-list-title">Information BH</p>
