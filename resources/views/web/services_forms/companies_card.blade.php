        ...
        <div class="pt-0">
            <div class="text-center">
                <label class="custom-switch">
                    ...
                    <span class="employee-label ml-1">{{ __('web.helpers.status') }}</span>
                </label>
            </div>
            <div class="text-center">
                <label class="custom-switch">
