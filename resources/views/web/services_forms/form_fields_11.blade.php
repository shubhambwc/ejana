...
<script>
	...
	$('#kind_of_lesson').on('change', function() {
	$('#kind_of_lesson_other').hide();
	$("#kind_of_lesson :selected").each(function() {
            if( this.value =='other'){
  			$('#kind_of_lesson_other').show();
  		}
        });
	...
	$('#music_style').on('change', function() {
	$('#music_style_other').hide();
	$("#music_style :selected").each(function() {
            if( this.value =='other'){
  			$('#music_style_other').show();
  		}
        });
	...
	$('#lesson_level').on('change', function() {
	$('#lesson_level_other').hide();
	$("#lesson_level :selected").each(function() {
            if( this.value =='other'){
  			$('#lesson_level_other').show();
  		}
        });
	});
	...
	$('#lesson_type_other').hide();
	$("#lesson_type :selected").each(function() {
            if( this.value =='other'){
  			$('#lesson_type_other').show();
  		}
        });
	});

	$('#where_do_you_do_that').on('change', function() {
	$('#where_do_you_do_that_other').hide();
	$("#where_do_you_do_that :selected").each(function() {
            if( this.value =='other'){
  			$('#where_do_you_do_that_other').show();
  		}
        });
	});
...
$('#available_for').on('change', function() {
 ...
 $('input[type=radio][name=do_you_have_tools]').change(function() {
    	if (this.value == 1) {
    		$('#do_you_have_tools_box').show();
    	}else{
    		$('#do_you_have_tools_box').hide();
    	}
    ...
    <div class="tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,null, ['id'=>'helpers_exprience','class' => 'form-control select-box required','required','placeholder' => 'How many years of experience do you have in Music?']) }}
                </div>
                </div>
               ...
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      {{ Form::label('extra_offer', __('What do you offer').':') }}
                      ...
                      , null, ['id'=>'extra_offer','class' => 'form-control select-box','multiple']) }}
                        {{ Form::text('extra_offer_other',null, ['id'=>'extra_offer_box_other','class' => 'form-control other_box','placeholder' => 'Enter Other']) }}
                 </div>
               ...
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      ...
                      'other'=>'Other']
                      , null, ['id'=>'kind_of_lesson','class' => 'form-control select-box','multiple']) }}

                 		{{ Form::text('kind_of_lesson_other',null, ['id'=>'kind_of_lesson_other','class' => 'form-control other_box','placeholder' => 'Enter Other']) }}
                 </div>
               ...
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      ...
                      'experts'=>'Experts',
                      'other'=>'Other']
                      , null, ['id'=>'lesson_level','class' => 'form-control select-box','multiple']) }}
                      {{ Form::text('lesson_level_other',null, ['id'=>'lesson_level_other','class' => 'form-control other_box','placeholder' => 'Enter Other']) }}
               ...
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      ...
                      'other'=>'Other']
                      , null, ['id'=>'lesson_type','class' => 'form-control select-box','multiple']) }}
                      {{ Form::text('lesson_type_other',null, ['id'=>'lesson_type_other','class' => 'form-control other_box','placeholder' => 'Enter Other']) }}
               ...
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      ...
                      'online'=>'Online',
                      'other'=>'Other']
                      , null, ['id'=>'where_do_you_do_that','class' => 'form-control select-box','multiple']) }}

                     {{ Form::text('where_do_you_do_that_other',null, ['id'=>'where_do_you_do_that_other','class' => 'form-control other_box','placeholder' => 'Enter Other']) }}
               ...
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      ...
                      'other'=>'Other']
                      , null, ['id'=>'music_style','class' => 'form-control select-box','multiple']) }}
                       {{ Form::text('music_style_other',null, ['id'=>'music_style_other','class' => 'form-control other_box','placeholder' => 'Enter Other']) }}
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('age_group', __('What age group do you want to teach?').':') }}<span class="text-danger">*</span>
                      {{ Form::select('age_group',
                      ['upto12years' =>'Up to 12 years' , '12-17years' =>'12 to 17 years)' ,'18yearandolder'=>'18 year and older']
                      ,null, ['id'=>'age_group','class' => 'form-control select-box required','placeholder'=>'Select age group']) }}
                </div></div>
...
<div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    {{ Form::label('do_you_have_tools', __('Do you have your own tools/supplie').':') }}<span class="text-danger">*</span><br>
                    {{ Form::radio('do_you_have_tools', '1',false)  ,['class' => 'form-control check-box']}} {{ __('web.helpers.yes') }}
                &nbsp;&nbsp;&nbsp;
                {{ Form::radio('do_you_have_tools', '0',true),[ 'class' => 'form-control check-box'] }} {{ __('web.helpers.no') }}

                </div>
    </div>

                <div class="row" id="do_you_have_tools_box" style="display:none">

               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('do_you_have_tools_text', __('Which one?').':') }}<span class="text-danger">*</span><br>
                      {{ Form::text('do_you_have_tools_text', null, ['class' => 'form-control']) }}
               </div>
                 </div>
    ...
    <div class="tabcontent pt-1 disable" id="tab4">
        ...
        <div class="row">
            ...
            {{ Form::radio('vog_certificate', '0',true),['class' => 'form-control check-box required','required'] }} {{ __('web.helpers.no') }}
              ...
              <p><b>Please note, without a VOG you cannot use the music. For more information please contact us.</b></p>
              </div>
