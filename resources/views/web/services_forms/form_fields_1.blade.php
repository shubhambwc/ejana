    ...
    <div class="tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                ...
                {{ Form::radio('competent', '1',false)  ,['onclick'=>'toggleCompetent("yes");', 'required']}} {{ __('web.helpers.yes') }}
                &nbsp;&nbsp;&nbsp;
                {{ Form::radio('competent', '0',true),['onclick'=>'toggleCompetent("no");', 'class' => 'form-control check-box required','required'] }} {{ __('web.helpers.no') }}
               ...
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                ...
                {{ Form::radio('do_you_smoke', '1',false)  ,['class' => 'form-control check-box']}} {{ __('web.helpers.yes') }}
                &nbsp;&nbsp;&nbsp;
                {{ Form::radio('do_you_smoke', '0',true),['class' => 'form-control check-box'] }} {{ __('web.helpers.no') }}
         ...
         {{ Form::label('passport_back_later', __("web.helpers.i_will_add_my_id_passport_later")) }}
          ...
          <div class="form-group col-xl-6 col-md-6 col-sm-12">
            ...
            {{ Form::radio('have_first_aid_certificate', '0',true),['class' => 'form-control check-box required','required'] }} {{ __('web.helpers.no') }}
              ...
              <p><b>{{ __('web.helpers.note_without_a_child_first_aid_certificate') }}</b></p>
              </div>
