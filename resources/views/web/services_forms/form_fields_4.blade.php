...
<script>
	...
	$("#extra_offer :selected").each(function() {
            if( this.value =='household_cleaning'){
  			        $('#household_cleaning_details').show();
  		    }
  		    if( this.value =='the_big_cleanup'){
  			        $('#the_big_cleanup_details').show();
  		    }
  		    if( this.value =='in_consultation_with_the_applicant_for_help'){
  			        $('#in_consultation_with_the_applicant_for_help_details').show();
  		    }
        });
    ...
    <div class="tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,null, ['id'=>'helpers_exprience','class' => 'form-control select-box required','required','placeholder' => 'How many years of experience do you have with domestic help?']) }}
                </div>
                </div>
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('get_experience_from', __('Where did you get that experience?').':') }}<span class="text-danger">*</span>
                      {{ Form::textarea('get_experience_from', null, ['class' => 'form-control required','rows' => '5']) }}
                </div>
                </div>
             ...
             <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 <p><b>Household cleaning tasks:</b></p>
                 </div>
              </div>

               <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 <p><input type="checkbox" name="extra_offer_light[]" value="Tidy up"> Tidy up</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Dust removal"> Dust removal</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Make up the bed(s)"> Make up the bed(s)</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Clearing and washing up"> Clearing and washing up</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Watering plants"> Watering plants</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Cook"> Cook</p>
                  <p><input type="checkbox" name="extra_offer_light[]" value="Vacuum"> Vacuum</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Mop"> Mop</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Scrubbing rooms/sanitary/kitchen"> Scrubbing rooms/sanitary/kitchen</p>
              </div>

              <div class="form-group col-xl-6 col-md-6 col-sm-12">

                 <p><input type="checkbox" name="extra_offer_light[]" value="Changing beds"> Changing beds</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Taking out the trash"> Taking out the trash</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Washing, drying and ironing"> Washing, drying and ironing</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Window patching"> Window patching</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Removing doors"> Removing doors</p>
                 <p><input type="checkbox" name="extra_offer_light[]" value="Shoppingn"> Shoppingn</p>
                  <p><input type="checkbox" name="extra_offer_light[]" value="in consultaion with the requestor"> in consultaion with the requestor</p>
                 <p><input  id="extra_offer_heavy_other_value" type="checkbox" name="extra_offer_light[]" value="Other"> Other</p>
                 <p id="extra_offer_heavy_other" style="display:none">{{ Form::text('extra_offer_heavy_other', null, ['class' => 'form-control',]) }}</p>
                 </div>
            ...
            <div class="row">
             ...
             <p><b>The bog Cleanup:</b></p>
                 <p><input type="checkbox" name="extra_offer_bob" value="The Great Cleaning"> The Great Cleaning<a href="#" class="tooltip_icon" data-toggle="tooltip" title="Kitchen: Cleaning of kitchen unit/countertop. Inside and outside of kitchen cabinets, oven, fridge and microwave.&#013;
...
Sweep the balcony and remove fencing.">?</a></p>
    ...
    <div class="tabcontent pt-1 disable" id="tab4">
         ...
         <div class="custom-form">
                 <div id="message3">Additional information and John takes the protection of your data seriously,but does not provide your personal data to third parties without your consent. Mhonor informatie can be found in the Privacy Policy.</div>
            </div>
                <div class="row">
    ...
    <div class="tabcontent pt-1 disable" id="tab5">
       ...
       <div class="row">
        ...
        <div class="row">
         ...
         <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  {{ Form::label('afraid_of_cleaning_products', __('Are you allergic to certain cleaning products?')) }}<span class="text-danger">*</span>
                  {{ Form::text('afraid_of_cleaning_products', null, ['class' => 'form-control required']) }}
        </div>
        </div>
