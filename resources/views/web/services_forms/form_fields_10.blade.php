...
<script>
    ...
    $('input[type=radio][name=have_passenger_insurance]').change(function() {
    	if (this.value == 1) {
    		$('#have_passenger_insurance_box').show();
    		$('#have_passenger_insurance_box_no').hide();
    	}else{
    		$('#have_passenger_insurance_box').hide();
    		$('#have_passenger_insurance_box_no').show();
    	}
   ...
   $('#available_for').on('change', function() {
    ...
    <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    ...
                    {{ Form::radio('gender', 'male',false) }} {{ __('web.helpers.male') }} &nbsp;&nbsp;&nbsp;
                    {{ Form::radio('gender', 'female',true )}} {{ __('web.helpers.female') }}
                </div>
    </div>
    <div class="row">
    ...
    <div class="tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,null, ['id'=>'helpers_exprience','class' => 'form-control select-box required','required','placeholder' => 'How many years of experience do you have in transport or passenger transport?']) }}
                </div>
                </div>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('type_of_transport', __('Type of transport?').':') }}<span class="text-danger">*</span>
                     ...
                     {{ Form::text('type_of_transport_other', null, ['id'=>'type_of_transport_other','class' => 'form-control other_box','placeholder'=>'Enter other']) }}
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('mean_of_transport', __('Mean of transport?').':') }}<span class="text-danger">*</span>
                    ...
                    {{ Form::text('mean_of_transport_other', null, ['id'=>'mean_of_transport_other','class' => 'form-control other_box','placeholder'=>'Enter other']) }}
                ...
                <div class="row" id="child_transport_box" style="display:none">
                   ...
                   <div class="form-group col-xl-6 col-md-6 col-sm-12">
                        {{ Form::label('child_pickup', __('Pick up child?').':') }}<br>
                        {{ Form::radio('child_pickup', '1',false) ,['class' => 'form-control check-box']}} {{ __('web.helpers.yes') }}
                        &nbsp;&nbsp;&nbsp;

                        {{ Form::radio('child_pickup', '0',true),['class' => 'form-control check-box'] }} {{ __('web.helpers.no') }}<br>
                        <div id="child_bring_to_box" style="display:none">
                        {{ Form::label('child_bring_to', __('To').':') }}</br>
                      ...
                      ,null, ['id'=>'child_bring_to','class' => 'form-control select-box','multiple']) }}
                        ...
                        {{ Form::text('child_bring_to_other', null, ['id'=>'child_bring_to_other','class' => 'form-control other_box','placeholder'=>'Enter other']) }}
                  ...
                  <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('child_bring', __('Bring a child?').':') }}<br>
                      {{ Form::radio('child_bring', '1',false) ,['class' => 'form-control check-box']}} {{ __('web.helpers.yes') }}
                        &nbsp;&nbsp;&nbsp;
                      {{ Form::radio('child_bring', '0',true),['class' => 'form-control check-box'] }} {{ __('web.helpers.no') }}<br>

                    <div id="child_bring_from_box" style="display:none">
                        {{ Form::label('child_bring_from', __('From').':') }}</br>
                      ...
                      {{ Form::text('child_bring_from_other', null, ['id'=>'child_bring_from_other','class' => 'form-control other_box','placeholder'=>'Enter other']) }}
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('how_many_passengers', __('How many passengers?').':') }}<span class="text-danger">*</span>
                 ...
                 <div class="form-group col-xl-6 col-md-6 col-sm-12">
                        {{ Form::label('cargo_space', __('Cargo space?').':') }}</br>
                        {{ Form::text('cargo_space', null, ['class' => 'form-control']) }}
                  </div>


                  <div class="form-group col-xl-6 col-md-6 col-sm-12">
                        {{ Form::label('other_option', __('Other options?').':') }}</br>
                      ...
                      {{ Form::text('other_option_other', null, ['id'=>'other_option_other','class' => 'form-control other_box','placeholder'=>'Enter other']) }}
                  </div>
               ...
               <div class="form-group col-xl-12 col-md-12 col-sm-12">
                  <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                       {{ Form::label('extra_offer', __('Offers you something extra').':') }}
                       {{ Form::text('extra_offer', null, ['class' => 'form-control required','required']) }}
                 </div>
 ...
 <div class="row">
          ...
          <div class="form-group col-xl-6 col-md-6 col-sm-12">
            ...
            {{ Form::radio('have_first_aid_certificate', '1',false) ,['class' => 'form-control check-box required ','required']}} {{ __('web.helpers.yes') }}
            &nbsp;&nbsp;&nbsp;
            {{ Form::radio('have_first_aid_certificate', '0',true),['class' => 'form-control check-box required','required'] }} {{ __('web.helpers.no') }}
              ...
              <div id="have_first_aid_certificate_box" style="display:none">
               ...
               {{ Form::label('first_aid_certificate', __('web.helpers.add_copy_of_first_aid_certificate').':') }}
                <div class="custom-file">
                        <input type="file" name="first_aid_certificate" id="image4" class="custom-file-input">
                         <label class="custom-file-label rounded" name="image4"><i class="mdi mdi-cloud-upload mr-1"></i>{{ __('web.helpers.upload_certificate_photo') }}</label>
                 </div>
               ...
               {{ Form::label('first_aid_certificate_later', __('web.helpers.i_will_add_padiatric_later')) }}


             </div>

              <div id="have_first_aid_certificate_box_no">
              <p><b>Please note, without a child first aid certificate you cannot use the transport for carry the children. For more information please contact us.</b></p>
              </div>
         ...
         <div class="row">
            ...
            {{ Form::label('have_passenger_insurance', __('Do you have passenger insurance?')) }}<a data-toggle="tooltip" title="If you are carrying a passenger or children it is important that you have passenger insurance in case something happens.">?</a><br>
            {{ Form::radio('have_passenger_insurance', '1',false) ,['class' => 'form-control check-box required']}} {{ __('web.helpers.yes') }}
            &nbsp;&nbsp;&nbsp;
            {{ Form::radio('have_passenger_insurance', '0',true),['class' => 'form-control check-box required'] }} {{ __('web.helpers.no') }}


              <div id="have_passenger_insurance_box" style="display:none">
                    {{ Form::label('have_passenger_insurance_with', __('web.helpers.with_whoom')) }}
                    {{ Form::text('have_passenger_insurance_with', null, ['class' => 'form-control']) }}

               {{ Form::label('passenger_insurance', __('Add a copy of your passenger insurance').':') }}
                <div class="custom-file">
                        <input type="file" name="passenger_insurance" id="image44" class="custom-file-input">
                         <label class="custom-file-label rounded" name="image44"><i class="mdi mdi-cloud-upload mr-1"></i>Upload Passenger Insurance Photo</label>
                 </div>
                 <div class="custom-file-preview" id="custom-file-image44" style="display:none">
                <img id="image44_preview" src="{}" />
                </div>

               {{ Form::checkbox('passenger_insurance_later', 'yes',false) ,['class' => 'form-control check-box'] }}
               {{ Form::label('passenger_insurance_later', __('I will add copy of Passenger Insurance to my account later')) }}


             </div>

              <div id="have_passenger_insurance_box_no">
              <p><b>Please note, without the passenger insurance you cannot use the transport for carry or passenger. for more information please contact us.</b></p>
              </div>
        ...
        <div class="row">
            ...
            {{ Form::radio('vog_certificate', '0',true),['class' => 'form-control check-box required','required'] }} {{ __('web.helpers.no') }}
              ...
              <p><b>Please note, without a VOG you cannot use the transport. For more information please contact us.</b></p>
              </div>
