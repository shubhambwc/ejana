    ...
    <div class="tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,null, ['id'=>'helpers_exprience','class' => 'form-control select-box required','required','placeholder' => 'How many years of experience do you have with computers?']) }}
                </div>
                </div>
                ...
                <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('type_of_device', __('What type of device').':') }}<span class="text-danger">*</span>
                      ...
                      ,null, ['class' => 'form-control select-box select_box_other','placeholder' => 'Select device']) }}
                      {{ Form::text('type_of_device_other', null, ['class' => 'form-control other_box','placeholder' => 'Enter other']) }}

                </div>

                 <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('operating_systems', __('Operating System').':') }}<span class="text-danger">*</span>
                      {{ Form::select('operating_systems',
                      ['android' =>'Android' , 'iOS' =>'iOS' ,'macOS'=>'macOS','Windows'=>'Windows','other'=>'Other']
                      ,null, ['class' => 'form-control select-box select_box_other','placeholder' => 'Select OS']) }}
                     {{ Form::text('operating_systems_other', null, ['class' => 'form-control other_box','placeholder' => 'Enter other']) }}
