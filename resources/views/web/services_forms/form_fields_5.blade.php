...
$('input[type=checkbox][id=extra_offer_light_other_value]').change(function() {
    ...
    <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    ...
                    {{ Form::radio('gender', 'male',"checked") }} {{ __('web.helpers.male') }} &nbsp;&nbsp;&nbsp;
                    {{ Form::radio('gender', 'female',"" )}} {{ __('web.helpers.female') }}
                </div>
    </div>
    <div class="row">
...
<div class="row">
            ...
            <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    {{ Form::label('do_you_have_gardentools', __('Do you have your own gardentools').':') }}<span class="text-danger">*</span><br>
                    {{ Form::radio('do_you_have_gardentools', '1',false)  ,['class' => 'form-control check-box']}} {{ __('web.helpers.yes') }}
                &nbsp;&nbsp;&nbsp;
                {{ Form::radio('do_you_have_gardentools', '0',true),[ 'class' => 'form-control check-box'] }} {{ __('web.helpers.no') }}
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('gardentools', __('Which one?').':') }}<br>
                      {{ Form::text('gardentools', null, ['class' => 'form-control']) }}
...
<div class="row">
    ...
    <div class="tabcontent pt-1 disable" id="tab5">
      ...
      <div class="row">
         ...
         <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  {{ Form::label('allergic_of_cleaning_means', __('Are you allergic to certain cleaning-means')) }}<span class="text-danger">*</span>
                  {{ Form::text('allergic_of_cleaning_means', null, ['class' => 'form-control required']) }}
        </div>
        </div>
