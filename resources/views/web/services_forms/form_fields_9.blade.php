...
$('#available_for').on('change', function() {
    ...
    <div class="tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                 <div id="message3">{{ __('web.helpers.what_is_your_experience_as_a') }} {{$JobCategoryDetail->name}}? <br>
                 <p style="margin: 0;font-size: 16px;">You will work with elderly people who are no longer physically able to do everything themselves, and/or, for example, have early Parkinson's disease or dementia. Don't underestimate what you mean to them when you come to their home. Thanks to you, they don't have to move to a healthcare facility.</p>
                 </div>
            </div>
                <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,null, ['id'=>'helpers_exprience','class' => 'form-control select-box required','required','placeholder' => 'How many years of experience do you have with elderly care?']) }}
                </div>
                </div>
             ...
             <div class="row">
               ...
               <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                      {{ Form::label('extra_offer', __('What do you offer').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="You provide light support and companionship to the elderly. It is always about light care tasks care performed by professional caregivers. like:">?</a>
                      {{ Form::select('extra_offer[]',
                      ['plan_activities' =>'Plan  activities' ,
                      'elderly_company' =>'Keep the elderly company' ,
                      'doiwng_activities'=>'Doing activities/hobby with the elderly/trips',
                      'domestic_help'=>'Domestic help',
                      'service_shopping'=>'Shopping service/shopping',
                      'elderly_walk'=>'Visiting the elderly to walk',
                      'support_in_dementia'=>'Support in dementia',
                      'social_support'=>'Social Support',
                      'assisting_with_appointments'=>'Assisting with appointments at the hospital or with the general practioner',
                      'reading_the_newspaper'=>'Reading the newspaper together to the library',
                      'internet_and_email'=>'Internet and email',
                      '1ccounting'=>'Accounting',
                      'other'=>'Other']
          ...
          <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 ...
                 <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    {{ Form::label('which_direction', __('Which direction').':') }}<span class="text-danger">*</span>
                    {{ Form::text('which_direction', null, ['class' => 'form-control required']) }}
                </div>
               </div>
                 ...
                 <div class="form-group col-xl-12 col-md-12 col-sm-12">
                 <div class="col-xl-6 col-sm-12" style="padding-left:0px;">
                {{ Form::label('do_smoke', __('web.helpers.do_you_smoke').':') }}</br>
                {{ Form::radio('do_smoke', '1',false),['class' => 'form-control check-box required']}} {{ __('web.helpers.yes') }}
                &nbsp;&nbsp;&nbsp;
                {{ Form::radio('do_smoke', '0',true),['class' => 'form-control check-box required'] }} {{ __('web.helpers.no') }}
                  </div>
    ...
    <div class="tabcontent pt-1 disable" id="tab4">
         ...
         <div class="custom-form">
                 ...
                 <p style="margin: 0;font-size: 16px;">{{ __('web.helpers.ejana_takes_the_protection_of_your_data_seriously') }}</p>
                 </div>
            </div>
                <div class="row">
 ...
 <div class="row">
          ...
          <div class="form-group col-xl-6 col-md-6 col-sm-12">
            ...
            {{ Form::radio('have_first_aid_certificate', '0',true),['class' => 'form-control check-box required','required'] }} {{ __('web.helpers.no') }}
              ...
              <p><b>Please note, without a child first aid certificate you cannot use the Home care  service. For more information please contact us.</b></p>
              </div>
        ...
        <div class="row">
            ...
            {{ Form::radio('vog_certificate', '0',true),['class' => 'form-control check-box required','required'] }} {{ __('web.helpers.no') }}
              ...
              <p><b>Please note, without a VOG you cannot use the Home care service. For more information please contact us.</b></p>
              </div>
