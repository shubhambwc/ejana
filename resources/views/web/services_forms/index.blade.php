            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class=" text-white inner-title">
                        <h5 class="text-uppercase title text ">{{$JobCategoryDetail->name}} {{ __('web.helpers.service_details') }}</h5>
                    </div>
                </div>
                 <div class="col-md-6">
 ...
 <?php if(isset($serviceId) && $serviceId!=''){ ?>
   ...
   <?php  }else{ ?>
                        ...
                        <a onclick="openCity(event, 'tab4' ,'tabb4')" id="tabb4" class="nav-link side_nav tablinks">
                           <strong>{{ __('web.helpers.extra_information') }}</strong>
                        </a>

                        <a onclick="openCity(event, 'tab5','tabb5')"  id="tabb5" class="nav-link side_nav tablinks">
                           <strong>{{ __('web.helpers.tell_us_who_you_are') }}  </strong>
                        </a>
                        ...
                        <a onclick="openCity(event, 'tab6','tabb6')"  id="tabb6" class="nav-link side_nav tablinks">
                         ...
                         <a  onclick="openCity(event, 'tab7','tabb7')" id="tabb7" class="nav-link side_nav tablinks">
                           <strong>{{ __('web.helpers.references') }} </strong>
                        </a>
   ...
   <?php  } ?>
    ...
    <a style="margin: 20px 0;width:100%" href="{{ route('choose-another-service') }}" class="btn btn-secondary text-dark">
            <strong>{{ __('web.helpers.cancel_and_select_another_service') }}</strong>
     </a>
</div>
</div>
...
<div class="row">
              ...
              <div class="rounded shadow bg-white p-4">
                           ...
                           {{ Form::hidden('MultipleServices',$MultipleServices) }}
                            @include('web.services_forms.form_fields_'.$serviceId)
                           {{ Form::close() }}
