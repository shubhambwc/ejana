...
$('input[type=radio][name=do_you_have_gardentools]').change(function() {
    ...
    <div class="tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      ,null, ['id'=>'helpers_exprience','class' => 'form-control select-box required','required','placeholder' => 'How many years of experience do you have as a handyman?']) }}
                </div>
                </div>
 ...
 <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                     {{ Form::label('extra_offer', __('What are you offering?').':') }}<span class="text-danger">*</span>
                  ...
                  <div class="row" id="extra_offer_box_other" style="display:none">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                {{ Form::text('extra_offer_other', null, ['class' => 'form-control','placeholder'=>'Enter other']) }}
                  ...
                  <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    {{ Form::label('do_you_have_gardentools', __('Do you have your own stuff/tools').':') }}<span class="text-danger">*</span><br>
