            ...
            <div class="row">
                    ...
                    <div class="job-detail  text-center job-single border rounded p-4">
                        ...
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item mr-3">
                                <p class="text-muted mb-2"><i class="mdi mdi-bank mr-1"></i>{{ (!empty(@$postMetaArray['full_name'])) ? @$postMetaArray['full_name'].', ' : '' }}</p>
                            </li>

                            <li class="list-inline-item">
                                <p class="text-muted mb-2"><i class="mdi mdi-map-marker mr-1"></i> {{ (!empty(@$postMetaArray['address'])) ? @$postMetaArray['address'].', ' : '' }} 
                                        {{ (!empty(@$postMetaArray['zip_code'])) ? @$postMetaArray['zip_code'].', ' : '' }}</p>
                            </li>
                        ...
                        <p class="text-muted mb-0"> {{ (!empty(@$postMetaArray['advertisement_text'])) ? @$postMetaArray['advertisement_text'].', ' : '' }}</p>
                    </div>
                ...
                <div class="col-lg-4 col-md-5 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    ...
                    <div class="job-detail rounded border job-overview  mb-4">
                        @if(!empty(@$postMetaArray['minimum_exp']))
                        <div class="single-post-item mb-4">
                            ...
                            <div class="overview-details">
                                ...
                                <h6 class="text-black-50 pt-2 mb-0">{{ (!empty(@$postMetaArray['minimum_exp'])) ? @$postMetaArray['minimum_exp'].' ,': '' }} - {{ (!empty(@$postMetaArray['maximum_exp'])) ? @$postMetaArray['maximum_exp'].' , ' : '' }} Years Exp.</h6>
                            </div>
                        ...
                        <div class="single-post-item mb-4">
                            ...
                            <div class="overview-details">
                                ...
                                <h6 class="text-black-50 pt-2 mb-0">{{$title}} </h6>
                            </div>
                        </div>
                        ...
                        @if(!empty(@$postMetaArray['user_signature_date']))
                        ...
                        <div class="single-post-item mb-4">
                            ...
                            <div class="overview-details">
                                ...
                                <h6 class="text-black-50 pt-2 mb-0">{{ @$postMetaArray['user_signature_date'] }}</h6>
                            </div>
                        </div>
                         @endif
                         @if(!empty($companyDetail->user->email))
                        ...
                        <div class="single-post-item mb-4">
                            ...
                            <div class="overview-details">
                                ...
                                <h6 class="text-black-50 pt-2 mb-0">{{ $companyDetail->user->email }}</h6>
                            </div>
                        </div>
                        @endif
                         @if(!empty(@$postMetaArray['phone']))
                        ...
                        <div class="single-post-item">
                            ...
                            <div class="overview-details">
                                ...
                                <h6 class="text-black-50 pt-2 mb-0">{{@$postMetaArray['phone']}}</h6>
                            </div>
                        </div>
                          @endif
                    </div>
                    ...
                    <div class="job-details-desc-item mt-2">
                        ...
                        <p class="text-muted mb-2">{{ (!empty(@$postMetaArray['address'])) ? @$postMetaArray['address'].', ' : '' }} 
                                        {{ (!empty(@$postMetaArray['zip_code'])) ? @$postMetaArray['zip_code'].', ' : '' }}</p>
                    </div>
                    ...
                    <div class="mt-4">
                        @auth
                        @if($job_status == "0")
                        <!--  <a href="{{ route('apply-to-job',$ownerId) }}" class="btn btn-primary btn-block ">APPLY THIS JOB</a> -->
                         {{ Form::open(['route' => 'apply-to-job', 'files' => 'true', 'id' => 'applyjob']) }}
                                                        <input type="hidden" name="jobId" value="<?php echo $ownerId; ?>">
                                                         <input type="hidden" name="service_id" value="<?php echo $service_id; ?>">
                                                        
                                                        <button type="submit" id="" class="btn btn-primary btn-block"
                            >APPLY THIS JOB</button>{{ Form::close() }}
                         @else 
                          ...
                          @endif
                            ...
                            @guest
                             <a href="{{ route('front.candidate.login') }}" class="btn btn-primary btn-block ">APPLY THIS JOB</a>
