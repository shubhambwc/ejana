            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="text-center text-white inner-title">
                        <h3 class="text-uppercase title mb-4">{{$title}}</h3>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-7 col-md-9">
                                            ...
                                            <div class="job-list-desc">
                                                <h6 class="mb-2"><a href="{{ route('jobdetails',$jobCategorie['ownerId'] ) }}" class="text-dark">{{$jobTitle}}</a></h6>
                                                <p class="text-muted mb-0"><i class="mdi mdi-bank mr-2"></i>{{ $jobCategorie['full_name'] ?? '' }}</p>
                                                <ul class="list-inline mb-0">
                                                    <li class="list-inline-item mr-3">
                                                        <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i>
                                                            {{ $jobCategorie['address'] ?? '' }} ,  {{ $jobCategorie['zip_code'] ?? '' }}
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <div class="job-list-button-sm text-right">
                                                ...
                                                <span class="badge badge-success">{{ $jobCategorie['type_of_care'] ?? '' }}</span>
                                                <div class="mt-3">
                                     

                            @auth
                        @if($jobCategorie['job_status'] == "0")
                         ...
                         @else 
                          ...
                          @endif
                            ...
                            @guest
                             <a href="{{ route('front.candidate.login') }}" class="btn btn-sm btn-primary">APPLY</a>
                               
                            @endguest
                                                   <!--  <a href="{{ route('apply-to-job',$jobCategorie['ownerId']) }}" class="btn btn-sm btn-primary">Apply</a> -->
                                                </div>
