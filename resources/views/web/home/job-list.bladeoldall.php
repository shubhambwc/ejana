                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-7 col-md-9">
                                            ...
                                            <div class="job-list-desc">
                                                <h6 class="mb-2"><a href="{{ route('jobdetails',$jobCategorie['ownerId']) }}" class="text-dark">{{$jobCategorie['pageTitle']}}</a></h6>
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <div class="job-list-button-sm text-right">
                                                ...
                                                <div class="mt-3">
                                                    <a href="{{ route('apply-to-job',1) }}" class="btn btn-sm btn-primary">Apply</a>
                                                </div>
