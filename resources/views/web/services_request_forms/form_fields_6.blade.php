...
<script>
   ...
   $('input[type=radio][name=have_tools_supplies]').change(function() {
	...
	$('#afraid_of').on('change', function() {
	 ...
	 $('.what_needs_to_be_done_other_name').change(function() {
    if($(this).is(':checked')){
        $('#what_needs_to_be_done_other').show();
   } else{
        $('#what_needs_to_be_done_other').hide();
     }
    });
           ...
           <div class="custom-form">
             ...
             <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                     ...
                     'other'=>'Other']
                      ,null, ['class' => 'form-control select-box required','placeholder'=>'What type of home do you live in?']) }}
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  {{ Form::checkbox('what_needs_to_be_done[]', 'Plumbing masonry', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('what_needs_to_be_done[]', __('Plumbing masonry')) }}
                  </p>

                  <p>
                  {{ Form::checkbox('what_needs_to_be_done[]', 'Paint', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('what_needs_to_be_done[]', __('Paint')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('what_needs_to_be_done[]', 'Stucoo', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('what_needs_to_be_done[]', __('Stucoo')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('what_needs_to_be_done[]', 'Wallpaper', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('what_needs_to_be_done[]', __('Wallpaper')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('what_needs_to_be_done[]', 'Electricity', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('what_needs_to_be_done[]', __('Electricity')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('what_needs_to_be_done[]', 'Tiling', false) ,['class' => 'form-control check-box'] }}
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 <p>
                  {{ Form::checkbox('what_needs_to_be_done[]', 'Carpentry', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('what_needs_to_be_done[]', __('Carpentry')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('what_needs_to_be_done[]', 'Lay floor', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('what_needs_to_be_done[]', __('Lay floor')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('what_needs_to_be_done[]', 'Small Task', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('what_needs_to_be_done[]', __('Small Task')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('what_needs_to_be_done[]', 'In construction with helper', false) ,['class' => 'form-control check-box'] }}
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 {{ Form::text('what_needs_to_be_done_other', null, ['id'=>'what_needs_to_be_done_other','class' => 'form-control other_box','placeholder'=>'Enter Other']) }}
                </div>
