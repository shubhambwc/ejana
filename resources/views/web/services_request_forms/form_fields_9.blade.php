    ...
    <div class="tabcontent pt-1 disable" id="tab3">
           ...
           <div class="custom-form">
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  {{ Form::checkbox('preference[]', 'Plan activities', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Plan activities')) }}
                  </p>

                  <p>
                  {{ Form::checkbox('preference[]', 'Keep the elderly company', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Keep the elderly company')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('preference[]', 'Doing activities/hoby with the elderly/trips', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Doing activities/hoby with the elderly/trips')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('preference[]', 'Domestic help', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Domestic help')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('preference[]', 'Shopping service/shopping', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Shopping service/shopping')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('preference[]', 'Visiting the elderly to talk', false) ,['class' => 'form-control check-box'] }}
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  {{ Form::checkbox('preference[]', 'Social support', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Social support')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('preference[]', 'Assiging with appointments ar the hospital of with the general practioner', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Assiging with appointments ar the hospital of with the general practioner')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('preference[]', 'Reading the newspaper together to the library', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Reading the newspaper together to the library')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('preference[]', 'Internet and mail', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Internet and mail')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('preference[]', 'In Construction with helpper', false) ,['class' => 'form-control check-box'] }}
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    ...
                    {{ Form::radio('should_take_into_account', '1',false),['class' => 'form-control check-box required']}} {{ __('Yes') }}
                    &nbsp;&nbsp;&nbsp;
                    {{ Form::radio('should_take_into_account', '0',true),['class' => 'form-control check-box required'] }} {{ __('No') }}
             ...
             <div class="row" id="should_take_into_account_yes" style="display:none">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    {{ Form::label('like_what', __('Like What').':') }}<span class="text-danger">*</span></br>
