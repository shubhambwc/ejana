...
<script>
	...
	$('#your_living_area').on('change', function() {
  		if( this.value =='other'){
  			$('#your_living_area_other').show();
  		}else{
  			$('#your_living_area_other').hide();
  		}
	});
	$('#room_to_be_cleaned').on('change', function() {
  		if( this.value =='other'){
  			$('#room_to_be_cleaned_other').show();
  		}else{
  			$('#room_to_be_cleaned_other').hide();
  		}
	});
    ...
    <div class="tabcontent pt-1 disable" id="tab2">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('date_need', __('When do you need domestic help?').':') }}<span class="text-danger">*</span>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('type_of_help', __('Type of domestic help').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="One-off, Fixed days, Flexible days">?</a><span class="text-danger">*</span>
    ...
    <div class="tabcontent pt-1 disable" id="tab3">
           ...
           <div class="custom-form">
             ...
             <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                     ...
                     'kaprijtjeshuisanders'=>'kaprijtjeshuisanders',
                      ...
                      ,null, ['id'=>'type_of_property','class' => 'form-control select-box','placeholder'=>'What type of home do you live in?']) }}
            ...
            <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('your_living_area', __('How much is your living area').':') }}<span class="text-danger">*</span>
                      ...
                      '> 250'=>'250m2 and large',
                      'other'=>'Other']
                      ,null, ['id'=>'your_living_area','class' => 'form-control select-box','placeholder'=>'How much is your living area']) }}
                {{ Form::text('your_living_area_other', null, ['id'=>'your_living_area_other','class' => 'form-control other_box','placeholder'=>'Enter Other']) }}
                </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('room_to_be_cleaned', __('What room do you want to have cleaned').':') }}<span class="text-danger">*</span>
                     ...
                     ['bathrooms and toilet' =>'Bathrooms and toilet',
                      ...
                      ,null, ['id'=>'room_to_be_cleaned','class' => 'form-control select-box','placeholder'=>'What room do you want to have cleaned']) }}
                {{ Form::text('room_to_be_cleaned_other', null, ['id'=>'room_to_be_cleaned_other','class' => 'form-control other_box','placeholder'=>'Enter Other']) }}
                </div>
            </div>
            ...
            <div class="row">
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
               <p><b>Household leaning task:</b></p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  {{ Form::checkbox('preference[]', 'Tidy up', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Tidy up')) }}
                  </p>

                  <p>
                  {{ Form::checkbox('preference[]', 'Dust removal', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Dust removal')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Make up the bed(s)', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Make up the bed(s)')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Cleaning and washing up', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Cleaning and washing up')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Watering plants', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Watering plants')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Cook', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Cook')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Vacuum', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Vacuum')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Mop', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Mop')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('preference[]', 'Scrubbing rooms/sanitary/kitchan', false) ,['class' => 'form-control check-box'] }}
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                   <p>
                  {{ Form::checkbox('preference[]', 'Changing beds', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Changing beds')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Taking out he trash', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Taking out he trash')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Washing, drying and ironing', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Washing, drying and ironing')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Window patching', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Window patching')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Removing doors', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Removing doors')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Shopping', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Shopping')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'In construction with requestor', false) ,['class' => 'form-control check-box'] }}
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  {{ Form::checkbox('the_greate_cleaning', 'The Greate Cleaning', false) ,['class' => 'form-control check-box'] }}
