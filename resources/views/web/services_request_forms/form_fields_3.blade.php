...
<script>
	...
	$('#type_of_homework_supervisor').on('change', function() {
	$('#type_of_homework_supervisor_other').hide();
	$("#type_of_homework_supervisor :selected").each(function() {
            if( this.value =='other'){
  			$('#type_of_homework_supervisor_other').show();
  		}
        });
	});
    ...
    <div class="tabcontent pt-1 disable" id="tab2">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('date_need', __('When do you need a home work supervisor?').':') }}<span class="text-danger">*</span>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('type_of_homework_supervisor', __('Type of homework supervisor').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="One-off, Fixed days, Flexible days">?</a><span class="text-danger">*</span>
                      ...
                      ,null, ['id'=>'type_of_homework_supervisor','class' => 'form-control select-box required','multiple']) }}
                {{ Form::text('type_of_homework_supervisor_other', null, ['id'=>'type_of_homework_supervisor_other','class' => 'form-control other_box','placeholder'=>'Enter other']) }}
    ...
    <div class="tabcontent pt-1 disable" id="tab3">
           ...
           <div class="custom-form">
             ...
             <div class="row">
                               ...
                               <div class="form-group col-xl-6 col-md-5 col-sm-6">
                                    {{ Form::label('what_you_teach', __('I am looking for homework guidance?').':') }}
                ...
                <div id="additional_what_you_teach_row"  class="row">
