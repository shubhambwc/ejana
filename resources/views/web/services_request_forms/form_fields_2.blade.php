...
<script>
    ...
    <div class="tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('opvanglocatie', __('Opvanglocatie').':') }}<span class="text-danger">*</span>
                      {{ Form::select('opvanglocatie[]',
                      ['Eigenhuis' =>'Eigenhuis' ,
                      'With the childminder' =>'With the childminder' ,
                      'No preference'=>'No preference',
                      ]
                      , null, ['id'=>'opvanglocatie','class' => 'form-control select-box required','multiple']) }}
                </div>
    ...
    <div class="tabcontent pt-1 disable" id="tab4">
           ...
           <div class="custom-form">
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('objection_width_childminder', __('Objection to pets with the childminder').':') }}<span class="text-danger">*</span>
                      {{ Form::textarea('objection_width_childminder', null, ['class' => 'form-control required','row'=>'5']) }}
                </div>
