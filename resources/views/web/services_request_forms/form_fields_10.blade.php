           ...
           <div class="custom-form">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                ...
                <div class="row" id="child_transport_box" style="display:none">
                   ...
                   <div class="form-group col-xl-6 col-md-6 col-sm-12">
                        ...
                        {{ Form::radio('child_pickup', '1',false) ,['class' => 'form-control check-box']}} {{ __('Yes') }}
                        &nbsp;&nbsp;&nbsp;

                        {{ Form::radio('child_pickup', '0',true),['class' => 'form-control check-box'] }} {{ __('No') }}<br>
                  ...
                  <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      {{ Form::radio('child_bring', '1',false) ,['class' => 'form-control check-box']}} {{ __('Yes') }}
                        &nbsp;&nbsp;&nbsp;
                      {{ Form::radio('child_bring', '0',true),['class' => 'form-control check-box'] }} {{ __('No') }}<br>
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    ...
                    {{ Form::text('offer_extra', null, ['id'=>'offer_extra','class' => 'form-control']) }}
                </div>
             </div>
