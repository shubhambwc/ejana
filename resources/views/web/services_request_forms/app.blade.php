...
$('#additional_reference').on('click','.remove-reference',function(){
                    ...
                    $("#AddWhatYouTeach").click(function(){
                     ...
                     var newLangHtml = '<div class="additional_lang_row" id="AddWhatYouTeach'+AddWhatYouTeach+'" style="display: inline-flex;">';
                     newLangHtml +='<div class="form-group col-xl-6 col-md-6 col-sm-12">';
                     newLangHtml +='<select class="form-control select-box select_box_other" required=""  name="what_you_teach['+AddWhatYouTeach+'][name]">';
                     newLangHtml +='<option selected="selected" value="">Select What class do you teach?</option><option value="geography">Geography</option><option value="arabic">Arabic</option><option value="bassischool_3">Bassischool Group 3</option><option value="bassischool_4">Bassischool Group 4</option><option value="bassischool_5">Bassischool Group 5</option><option value="bassischool_6">Bassischool Group 6</option><option value="bassischool_7">Bassischool Group 7</option><option value="bassischool_8">Bassischool Group 8 </option><option value="bassischool_all_groups">Bassischool all groups</option><option value="business_economics">Business Economics</option><option value="biology">Biology</option><option value="german">German</option><option value="english">English</option><option value="philosophy">Philosophy</option><option value="french">French</option><option value="history">History</option><option value="music">Music (Guitar, Piano, Vocals ect)</option><option value="computer_science">Computer Science</option><option value="italian">Italian</option><option value="korean">Korean</option><option value="other">Other</option>';
                     newLangHtml +='</select>';
                     ...
                     newLangHtml +='<div class="col-xl-2 col-md-2 col-sm-12" style="margin-top:-8px;">';
