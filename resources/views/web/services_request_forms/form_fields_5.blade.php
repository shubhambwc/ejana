...
$('.activities_other_name').change(function() {
    ...
    <div class="tabcontent pt-1 disable" id="tab2">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('date_need', __('When do you need garden help?').':') }}<span class="text-danger">*</span>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('type_of_garden_help', __('Type of garden help').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="One-off, Fixed days, Flexible days">?</a><span class="text-danger">*</span>
    ...
    <div class="tabcontent pt-1 disable" id="tab3">
           ...
           <div class="custom-form">
             ...
             <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('garden_area', __('Garden area').':') }}<span class="text-danger">*</span>
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  {{ Form::checkbox('activities[]', 'Watering plants and flour', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Watering plants and flour')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Sowing plants', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Sowing plants')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Removing weeds', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Removing weeds')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Grasmaaien', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Grasmaaien')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Sweep', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Sweep')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Pruning, trimming and/or felling', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Pruning, trimming and/or felling')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Pond cleaning', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Pond cleaning')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Cleaning terrace/tiles/garden furniture', false) ,['class' => 'form-control check-box'] }}
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  {{ Form::checkbox('activities[]', 'Cleaning up the barn', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Cleaning up the barn')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Remainder', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Remainder')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Placing fence, disassembling', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Placing fence, disassembling')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Shoveling away sand/clay', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Shoveling away sand/clay')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Tilling/paving', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Tilling/paving')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'Placing/removing the pond', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('activities[]', __('Placing/removing the pond')) }}
                  </p>
                  <p>
                  {{ Form::checkbox('activities[]', 'In construction with the helper', false) ,['class' => 'form-control check-box'] }}
                  ...
                  {{ Form::label('activities[]', __('Other')) }}
                  </p>
                </div>
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 {{ Form::text('activities_other', null, ['id'=>'activities_other','class' => 'form-control other_box','placeholder'=>'Enter Other']) }}
                </div>
             ...
             <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    {{ Form::label('have_tool_supplies', __('Do you have all the tool/supplies yourself').':') }}<span class="text-danger">*</span></br>
                    {{ Form::radio('have_tool_supplies', '1',false),['class' => 'form-control check-box required']}} {{ __('Yes') }}
                    &nbsp;&nbsp;&nbsp;
                    {{ Form::radio('have_tool_supplies', '0',true),['class' => 'form-control check-box required'] }} {{ __('No') }}
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      {{ Form::label('remark', __('Comments').':') }}<a href="#" class="tooltip_icon" data-toggle="tooltip" title="Do you have any comments that are important to the gardner, for example: prefer not to smoke or rather someone who is not afraid of animals.">?</a><span class="text-danger">*</span>
                      {{ Form::textarea('remark', null, ['class' => 'form-control required','row'=>'5','placeholder'=>"E.g.: Beware! We have 2 big dogs it's just about the backyard."]) }}
                </div>
