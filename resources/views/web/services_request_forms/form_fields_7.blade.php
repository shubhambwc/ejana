...
<script>
	...
	$('#pet_involved').on('change', function() {

	    $('#pet_involved_other').hide();
	    $("#pet_involved :selected").each(function() {
            if( this.value =='other'){
  			$('#pet_involved_other').show();
  		}
        });
           ...
           <div class="custom-form">
             ...
             <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                     ...
                     'Birds'=>'Birds',
                     'other'=>'Other']
                      ,null, ['id'=>'pet_involved','class' => 'form-control select-box','multiple']) }}
             ...
             <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      {{ Form::text('number_of_pets', null, ['class' => 'form-control required']) }}
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  ...
                  <p>
                  {{ Form::checkbox('preference[]', 'Caring for animals in their own home', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Caring for animals in their own home')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'Caring for animals in your own home', false) ,['class' => 'form-control check-box'] }}
                  {{ Form::label('preference[]', __('Caring for animals in your own home')) }}
                  </p>
                   <p>
                  {{ Form::checkbox('preference[]', 'other', false) ,['class' => 'form-control check-box'] }}
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      ...
                      {{ Form::textarea('what_needs_to_be_done', null, ['class' => 'form-control required','row'=>'5','placeholder'=>"E.g. walking the dog twice a day, feedingand drinking and cleaning the Litter Box"]) }}
                </div>
