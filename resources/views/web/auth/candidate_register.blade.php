                    ...
                    <div class="col-md-6 pt-2">
                        <div class="login_page bg-white shadow rounded p-4">
                            <div class="text-center">
                                <h2 class="heading font-weight-bold pb-5">SIGN UP AS HELPER/HELP-REQUESTER</h2>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Waar ben je naar op zoek? <span class="text-danger">*</span></label>
                                            ...
                                            <div class="custom-control m-0 ">
                                                ...
                                                <label class="" for="customCheck2">Help Requester </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
...
@section('scripts')
    <script>
        ...
        let afterRegisterURL = "{{ route('candidate.selectservice','') }}";
