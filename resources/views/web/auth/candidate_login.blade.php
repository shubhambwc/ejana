                                  ...
                                  @include('flash::message')
                                       <form class="login-form" method="POST" action="{{ route('front.login') }}" id="candidateForm">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <p class="float-right forgot-pass"><a href="{{ route('front.forgot.password') }}" class="text-dark font-weight-bold">Forgot password ?</a></p>
                                            ...
                                            <div class="col-12 text-center">
                                                <p class="mb-0 mt-3"><small class="text-dark mr-2">Don't have an account ?</small> <a href="{{ route('our-pricing') }}" class="text-dark font-weight-bold">Sign Up</a></p>
                                               <p></p>
