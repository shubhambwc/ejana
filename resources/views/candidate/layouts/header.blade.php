            ...
            <li class="nav-item {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                <a href="{{ route('candidate.profile') }}"
                   class="nav-link {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                    ...
                    <span>{{ __('messages.candidate.account') }}</span>
                </a>
            </li>  
             <li class="nav-item {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                <a href="{{ route('candidate.profile') }}"
                   class="nav-link {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                    ...
                    <span>{{ __('messages.candidate.availability') }}</span>
                </a>
            </li>  
             <li class="nav-item {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                <a href="{{ route('candidate.profile') }}"
                   ...
                   <i class="fas fa-comment"></i>
                    <span>{{ __('messages.candidate.chat') }}</span>
                </a>
            </li>  
             <li class="nav-item {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                <a href="{{ route('candidate.profile') }}"
                   class="nav-link {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                    ...
                    <span>{{ __('messages.candidate.find_helper') }}</span>
                </a>
            </li>   
             <li class="nav-item {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                <a href="{{ route('candidate.profile') }}"
                   class="nav-link {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                    ...
                    <span>{{ __('messages.candidate.place_ad') }}</span>
                </a>
            </li> 
             <li class="nav-item {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                <a href="{{ route('candidate.profile') }}"
                   class="nav-link {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                    ...
                    <span>{{ __('messages.candidate.my_ad') }}</span>
                </a>
            </li>  
             <li class="nav-item {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                <a href="{{ route('candidate.profile') }}"
                   class="nav-link {{ Request::is('candidate/profile*') ? 'active' : ''}}">
                    ...
                    <span>{{ __('messages.candidate.berichten') }}</span>
                </a>
            </li>   
