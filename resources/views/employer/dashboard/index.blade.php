            ...
            <div class="card">
                <div class="card-header flex-wrap">
                    ...
                    <div class="card-header-action w-auto custom-flex-12 mt-0 text-right">
                        <a href="{{ route('job.index') }}" class="btn btn-info">{{ __('messages.common.view_more') }} <i class="fas fa-chevron-right"></i></a>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="badge w-auto badge-{{\App\Models\Job::STATUS_COLOR[$recentJob->status]}}">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                <div class="card-header flex-wrap">
                    ...
                    <div class="card-header-action w-auto custom-flex-12 mt-0 text-right">
                        <a href="{{ route('followers.index') }}" class="btn btn-info">{{ __('messages.common.view_more') }} <i class="fas fa-chevron-right"></i></a>
                    </div>
                </div>
                <div class="card-body p-0 mt-0">
                    <div class="table-responsive table-invoice table-bordered">
