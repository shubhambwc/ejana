...
@section('content')
    ...
    maxDate: new Date()
        ...
        <div class="section-body-tab" id="tab2" onClick="selectTab('tab2')" >Your Experience</div>
        <div class="section-body-tab " id="tab3"  onClick="selectTab('tab3')">Extra Information</div>
        <div class="section-body-tab" id="tab4"  onClick="selectTab('tab4')">Tell Us Who You Are?</div>
        <div class="section-body-tab" id="tab5"  onClick="selectTab('tab5')">Ad's Info</div>
        <div class="section-body-tab" id="tab6"  onClick="selectTab('tab6')">References</div>
        </div>
