...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1>
            <?php echo e(__('web.helpers.edit')); ?> <?php echo e($user->first_name); ?> <?php if(isset($_REQUEST['service_id']) && $_REQUEST['service_id']!=''){?> <?php echo e(__('web.helpers.profile_information')); ?> <?php }else{ ?> <?php echo e(__('web.helpers.service_details')); ?> <?php } ?></h1>
...
function ValidateAndSave(tabId){
   ...
   if(obj){
        ...
        <div class="section-body-tab active" id="tabb1" onClick="selectTab('0')"><?php echo e(__('web.helpers.details')); ?></div>
        <div class="section-body-tab" id="tabb2" onClick="selectTab('1')" ><?php echo e(__('web.helpers.profile_picture')); ?></div>
        <div class="section-body-tab " id="tabb3"  onClick="selectTab('2')"><?php echo e(__('web.helpers.experience')); ?></div>
        <div class="section-body-tab" id="tabb4"  onClick="selectTab('3')"><?php echo e(__('web.helpers.ad_info')); ?></div>
        <div class="section-body-tab" id="tabb5"  onClick="selectTab('4')"><?php echo e(__('web.helpers.contract')); ?></div>
        </div>
        ...
        <div class="section-body-tab" id="tabb2" onClick="selectTab('1')" ><?php echo e(__('web.helpers.profile_picture')); ?></div>
        <div class="section-body-tab " id="tabb3"  onClick="selectTab('2')"><?php echo e(__('web.helpers.experience')); ?></div>
        <div class="section-body-tab" id="tabb4"  onClick="selectTab('3')"><?php echo e(__('web.helpers.extra_information')); ?></div>
        <div class="section-body-tab" id="tabb5"  onClick="selectTab('4')"><?php echo e(__('web.helpers.who_you_are')); ?></div>
        <div class="section-body-tab" id="tabb6"  onClick="selectTab('5')"><?php echo e(__('web.helpers.ad_info')); ?></div>
        <div class="section-body-tab" id="tabb7"  onClick="selectTab('6')"><?php echo e(__('web.helpers.references')); ?></div>
        <div class="section-body-tab" id="tabb8"  onClick="selectTab('7')"><?php echo e(__('web.helpers.contract')); ?></div>
        </div>
        <?php }?>
        ...
        <div class="section-body section-body-section">
        <div class="section-body-tab active" id="tab1" onClick="selectRootTab('tab1')"><?php echo e(__('web.helpers.profile_information')); ?></div>
        <div class="section-body-tab" id="tab2" onClick="selectRootTab('tab2')" ><?php echo e(__('web.helpers.manage_services')); ?></div>
        <div class="section-body-tab" id="tab3" onClick="selectRootTab('tab3')" ><?php echo e(__('web.helpers.contact_moments')); ?></div>
        <div class="section-body-tab" id="tab4" onClick="selectRootTab('tab4')" ><?php echo e(__('web.helpers.bank_transactions')); ?></div>
        <div class="section-body-tab" id="tab5" onClick="selectRootTab('tab5')" ><?php echo e(__('web.helpers.booking')); ?></div>
        </div>
...
<!--  -->
        <div class="section-body section-body-section with_border">
            ...
            <div class="card">
                <div class="card-body">
                    <?php echo e(Form::open(['route' => 'candidates.update', 'files' => 'true', 'id' => 'editCandidatesForm'])); ?>



                     <?php echo e(Form::hidden('candidate_id',$candidate->id)); ?>
                     ...
                     <?php if(isset($_REQUEST['service_id']) && $_REQUEST['service_id']!=''){ ?>
                       ...
                       <?php echo $__env->make('candidates.edit_fields_'.$_REQUEST['service_id'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php }else{ ?>
                       <?php echo e(Form::hidden('service_id','')); ?>

                       <?php echo $__env->make('candidates.edit_fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php } ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        let countryId = '<?php echo e($candidate->user->country_id); ?>';
        let stateId = '<?php echo e($candidate->user->state_id); ?>';
        let cityId = '<?php echo e($candidate->user->city_id); ?>';
    ...
    <script src="<?php echo e(mix('assets/js/candidate/create-edit.js')); ?>"></script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/candidates/edit.blade.php ENDPATH**/ ?>