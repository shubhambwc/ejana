...
Response within 2 working days</p>
                        <div id="message"></div>
                            <?php echo e(Form::open(array('route' => 'send-contact-us'))); ?>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-7 mt-4 pt-2">
                    <div class="custom-form rounded border p-4">
                        <div id="message"></div>
                        <?php echo e(Form::open(array('route' => 'send-complaint-us'))); ?>
...
<?php echo $__env->make('web.webLayout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/home/contactus.blade.php ENDPATH**/ ?>