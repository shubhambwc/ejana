<div class="modal fade" id="reportToCompanyModal">
    <form name="frm" id="reportToCompany">
        ...
        <div class="modal-dialog">
            ...
            <input type="hidden" name="companyId" value="<?php echo e($companyDetail->id); ?>">
...
<?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/company/report_to_company_modal.blade.php ENDPATH**/ ?>