...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row candidate-profile">
                ...
                <div class="col-md-3 col-xs-12">
                    <div class="profile-photo">
                        <img src="<?php echo e(asset('web/img/client4.jpg')); ?>" class="img-responsive" alt="">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row portfolio-grid mt40">
                ...
                <div class="element col-md-4 col-sm-6 col-xs-6 portfolio-cat1">
                    <figure>
                        <a href="<?php echo e(asset('web/img/image1.jpg')); ?>" class="hover-zoom">
                            <img src="<?php echo e(asset('web/img/image1.jpg')); ?>" class="img-responsive" alt="">
                        </a>
                    </figure>
                </div>
    ...
    <section class="education ptb80">
        <div class="container">
            ...
            <div class="col-md-6">
                <div class="item-block shadow-hover">
                    ...
                    <div class="education-header clearfix">
                        <img src="<?php echo e(asset('web/img/envato.svg')); ?>" alt="">
                        <div>
            ...
            <!-- Start of Education Column -->
            <div class="col-md-6 j-education-col">
                <div class="item-block shadow-hover">
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/profile/candidate_profile.blade.php ENDPATH**/ ?>