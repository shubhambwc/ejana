...
$('#additional_what_you_teach_row').on('click','.remove_what_you_teach',function(){
     ...
     <?php if($serviceId == 1){ ?>
                       <div onclick="selectTab(0)" id="tabb1" class="section-body-tab active">
                            <strong>  <?php echo e(__('web.helpers.profile_information')); ?></strong>
                       </div>

                       <div onclick="selectTab(1)" id="tabb2" class="section-body-tab">
                            <strong>  <?php echo e(__('web.helpers.child_details')); ?></strong>
                       </div>
                        <div  onclick="selectTab(2)" id="tabb3" class="section-body-tab">
                            <strong>  <?php echo e(__('web.helpers.reception_information')); ?></strong>
                        </div>

                        <div onclick="selectTab(3)" id="tabb4" class="section-body-tab">
                            <strong>  <?php echo e(__('web.helpers.additional_information')); ?></strong>
                        </div>

                        <div onclick="selectTab(4)"  id="tabb5" class="section-body-tab">
                           <strong>  <?php echo e(__('web.helpers.requestor_add')); ?></strong>
                        </div>

                        <div  onclick="selectTab(5)" id="tabb6" class="section-body-tab">
                            <strong>  <?php echo e(__('web.helpers.profile_picture')); ?></strong>
                        </div>

                        <div  onclick="selectTab(6)" id="tabb7" class="section-body-tab">
                            <strong>  <?php echo e(__('web.helpers.contract')); ?></strong>
                        </div>
   ...
   <?php }elseif($serviceId == 5){ ?>
                      ...
                      <div onclick="selectTab(0)" id="tabb1" class="section-body-tab active">
                        ...
                        <div  onclick="selectTab(1)" id="tabb2" class="section-body-tab">
                            <strong>  Garden <?php echo e(__('web.helpers.help_information')); ?></strong>
                        </div>
     ...
     <?php }elseif($serviceId == 6){ ?>
                      ...
                      <div onclick="selectTab(0)" id="tabb1" class="section-body-tab active">
                        ...
                        <div  onclick="selectTab(1)" id="tabb2" class="section-body-tab">
                            <strong>  Job <?php echo e(__('web.helpers.help_information')); ?></strong>
                        </div>
   ...
   <?php }elseif($serviceId == 8){ ?>
                      ...
                      <div onclick="selectTab(0)" id="tabb1" class="section-body-tab active">
                        ...
                        <div  onclick="selectTab(1)" id="tabb2" class="section-body-tab">
                            <strong>  Computer <?php echo e(__('web.helpers.help_information')); ?></strong>
                        </div>
  ...
  <?php  }else{ ?>
                        ...
                        <div  onclick="selectTab(1)" id="tabb2" class="section-body-tab">
                            <strong>  <?php echo e(__('web.helpers.help_information')); ?></strong>
                        </div>
   ...
   <?php  }else{ ?>
        ...
        <div class="section-body-tab" id="tab4" onClick="selectRootTab('tab4')" ><?php echo e(__('web.helpers.bank_transactions')); ?></div>
         <div class="section-body-tab" id="tab5" onClick="selectRootTab('tab5')" ><?php echo e(__('web.helpers.job_applications')); ?></div>
        </div>
        ...
        <div class="section-body section-body-section with_border">
            ...
            <div class="card">
                <div class="card-body">
                    <?php echo e(Form::model($company, ['route' => ['company.update'], 'method' => 'post', 'files' => 'true', 'id' => 'editCompanyForm'])); ?>
                    ...
                    <?php if(isset($_REQUEST['service_id']) && $_REQUEST['service_id']!=''){ ?>
                       ...
                       <?php echo e(Form::hidden('service_id',$_REQUEST['service_id'])); ?>

                       <?php echo $__env->make('companies.edit_fields_'.$_REQUEST['service_id'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php }else{ ?>
                       <?php echo $__env->make('companies.edit_fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php } ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/companies/edit.blade.php ENDPATH**/ ?>