            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="text-center text-white inner-title">
                        <h3 class="text-uppercase title mb-4"><?php echo e($title); ?></h3>
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-lg-3">
                    <div class="left-sidebar">
                        <div class="accordion" id="accordionExample">
                            ...
                            <!-- collapse one end -->
                            <div class="card rounded mt-4" style="display: none;">
                ...
                <div class="col-12">
                    ...
                    <div class="row">
                         <?php if($joblistingdetail) { foreach($joblistingdetail as $jobCategorie){
                           // print_r($jobCategorie);
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-7 col-md-9">
                                            ...
                                            <div class="job-list-desc">
                                                <h6 class="mb-2"><a href="<?php echo e(route('jobdetails',$jobCategorie['ownerId'] )); ?>" class="text-dark"><?php echo e($jobTitle); ?></a></h6>
                                                <p class="text-muted mb-0"><i class="mdi mdi-bank mr-2"></i><?php echo e($jobCategorie['full_name'] ?? ''); ?></p>
                                                <ul class="list-inline mb-0">
                                                    <li class="list-inline-item mr-3">
                                                        <p class="text-muted mb-0"><i class="mdi mdi-map-marker mr-2"></i>
                                                            <?php echo e($jobCategorie['address'] ?? ''); ?> ,  <?php echo e($jobCategorie['zip_code'] ?? ''); ?>
                                                    ...
                                                    <li class="list-inline-item">
                                                        <p class="text-muted mb-0"><i class="mdi mdi-clock-outline mr-2"></i>
                                                            <?php 
                                                            if(!empty($jobCategorie['user_signature_date'])){
                                                            $now = time(); // or your date as well
                                                            $your_date = strtotime($jobCategorie['user_signature_date']);
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <div class="job-list-button-sm text-right">
                                                ...
                                                <span class="badge badge-success"><?php echo e($jobCategorie['type_of_care'] ?? ''); ?></span>
                                                <div class="mt-3">
                                     

                            <?php if(auth()->guard()->check()): ?>
                        <?php if($jobCategorie['job_status'] == "0"): ?>
                          <?php echo e(Form::open(['route' => 'apply-to-job', 'files' => 'true', 'id' => 'applyjob'])); ?>

                                                        <input type="hidden" name="jobId" value="<?php echo $jobCategorie['ownerId']; ?>">
                                                         <input type="hidden" name="service_id" value="<?php echo $jobCategorie['service_id']; ?>">
                                                        
                                                        <button type="submit" id="" class="btn btn-sm btn-primary"
                            >Apply</button><?php echo e(Form::close()); ?>

                         <?php else: ?> 
                          <a href="#" class="btn btn-sm btn-primary">Applied</a>
                          <?php endif; ?>
                                
                            <?php endif; ?>
                             
                            <?php if(auth()->guard()->guest()): ?>
                             <a href="<?php echo e(route('front.candidate.login')); ?>" class="btn btn-sm btn-primary">APPLY</a>
                               
                            <?php endif; ?>
                                                   <!--  <a href="<?php echo e(route('apply-to-job',$jobCategorie['ownerId'])); ?>" class="btn btn-sm btn-primary">Apply</a> -->
                                                </div>
...
<?php echo $__env->make('web.webLayout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/home/job-list.blade.php ENDPATH**/ ?>