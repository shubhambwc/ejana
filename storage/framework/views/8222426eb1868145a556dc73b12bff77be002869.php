...
<table class="table table-responsive-sm table-striped table-bordered" id="momentTable">
    ...
    <tr>
            <td><?php echo e($moment->first_name); ?> <?php echo e($moment->last_name); ?></td>
            ...
            <td class="text-center">
                <a href="<?php echo e(URL('admin/contact_moment/'.$moment->id.'/edit' )); ?>" title="Edit" class="btn btn-warning action-btn" data-id="<?php echo e($moment->id); ?>" id="<?php echo e($moment->id); ?>">
...
let tableId = '#momentTable';
    ...
    <?php $__env->stopPush(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/moments/table.blade.php ENDPATH**/ ?>