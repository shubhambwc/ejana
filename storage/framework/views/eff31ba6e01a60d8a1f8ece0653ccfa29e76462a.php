...
<div class="row section_tab active" id="section_tab1">
    ...
    <div class="form-group col-xl-6 col-md-6 col-sm-12">
        <?php echo e(Form::label('first_name', __('First Name').':')); ?><span class="text-danger">*</span>
        <?php echo e(Form::text('first_name', isset($user)?$user->first_name:null, ['class' => 'form-control','required'])); ?>

    </div>
    
    <div class="form-group col-xl-6 col-md-6 col-sm-12">
        <?php echo e(Form::label('last_name', __('Last Name').':')); ?><span class="text-danger">*</span>
   ...
   <div class="form-group col-sm-12">
     <div style="float:left">
        <a href="<?php echo e(route('company.index')); ?>" class="btn btn-secondary text-dark"><?php echo e(__('messages.common.cancel')); ?></a>
    </div>
     <div style="float:right">
        <?php echo e(Form::submit(__('messages.common.save'), ['class' => 'btn btn-primary', 'id' => 'btnSave'])); ?>
                ...
                <div class="w-100">
                    <div class="text-left employee-data text-limit">
                        <span class="text-decoration-none text-color-gray">
                            <a href="<?php echo e(route('company.index')); ?>/<?php echo e($company->id); ?>/edit?service_id=<?php echo e($jobCategory->id); ?>" class="show-btn">
                    ...
                    <div class="text-left employee-date mt-2">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="employee-label ml-1"><?php echo e(__('Is Service Active')); ?></span>
                        </label>
                        <?php
...
<!-- Tab 3 -->
      <div class="row section_tab" id="section_tab3">
            ...
            <div class="section-header-breadcrumb" >
                            <a href="<?php echo e(URL('admin/moments/'.$company->id.'/add/'.$user->id )); ?>"
                               class="btn btn-primary form-btn float-right" style="margin:8px" ><?php echo e(__('messages.common.add')); ?> <i class="fas fa-plus"></i></a>
                              
                        </div>

            <?php echo $__env->make('companies.reminder.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            </div>
      </div>
...
<!-- Tab 4 -->
      <div class="row section_tab" id="section_tab4">
                <div class="card" style="width:100%"> 
                                <div class="card-body">
                <?php echo $__env->make('companies.transaction.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<!-- Tab 5 -->
      <div class="row section_tab" id="section_tab5">
                <div class="card" style="width:100%"> 
                                <div class="card-body">
                <?php echo $__env->make('companies.job_application.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


                </div>
                </div>
      </div><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/companies/edit_fields.blade.php ENDPATH**/ ?>