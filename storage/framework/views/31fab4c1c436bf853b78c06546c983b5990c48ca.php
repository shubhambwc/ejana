                    ...
                    <div class="col-md-6 pt-2">
                        <div class="login_page bg-white shadow rounded p-4">
                            <div class="text-center">
                                ...
                                <?php echo e(Form::open(array('route' => 'update-services','id' =>'new_user_form'))); ?>

                           		 <input type="hidden"  name="service_id" value="<?php echo e($service_id); ?>">
                           		 <input type="hidden"  name="owner_id" id="owner_id" value="">
                           		 <input type="hidden" name="type" value="<?php echo e($type); ?>">
                           		 <input type="hidden"  name="multiple_services" id="multiple_services" value="<?php echo e($multiple_services); ?>">
                           		<?php echo e(Form::close()); ?> 
                            
                            
                                
                                <div id="candidate">
                                     <?php echo e(Form::open(['id'=>'addCandidateNewForm'])); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            <label><?php echo e(__('web.common.first_name').":"); ?><span
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                             <label><?php echo e(__('web.common.password').":"); ?> <span
                                                class="required asterisk-size">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                                <label><?php echo e(__('web.common.confirm_password').":"); ?>
                                    ...
                                    <label class="form-check-label"
                                           for="exampleCheck1"><?php echo e(__('messages.i_agree')); ?>                               
                                    </label>
                                            </div>
                                            <?php if($isGoogleReCaptchaEnabled): ?>
                                    ...
                                    <div class="col-md-12">
                                        <button  type="submit" class="btn btn-primary w-100 " data-loading-text="<span class='spinner-border spinner-border-sm'></span> Processing..."  id="btnCandidateSave"><?php echo e(__('web.register_menu.register')); ?></button>
                                    </div>

                                    <div class="mx-auto">
                                        <p class="mb-0 mt-3"><small class="text-dark mr-2">Already have an account ?</small> <a href="<?php echo e(route('front.candidate.login')); ?>" class="text-dark font-weight-bold">Sign in</a></p>
                                        <p></p>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        let afterSignup = "<?php echo e(route('update-services')); ?>";
        let candidateLogInUrl = "<?php echo e(route('front.candidate.login')); ?>";
        let isGoogleReCaptchaEnabled = "<?php echo e((boolean)$isGoogleReCaptchaEnabled); ?>";
    </script>
    <script src="<?php echo e(mix('assets/js/front_register/front_register.js')); ?>"></script>
    <?php if($isGoogleReCaptchaEnabled): ?>
        <script src="<?php echo e(mix('assets/js/front_register/google-recaptcha.js')); ?>"></script>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
</div>
...
<?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/home/create-account.blade.php ENDPATH**/ ?>