      ...
      <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <h3 class="text-uppercase title text1">About Ejana</h3>
                       <a href="/" class="text-uppercase font-weight-bold">Home</a> > <span class="text-uppercase text-white font-weight-bold">About Ejana</span>
                 ...
                 <div class="col-md-6">
                    <div class="  inner-title" style="margin-top:35px;">
                       <img src="assets/images/about-banner.png" alt="" class="img-fluid mx-auto d-block right">
...
<p class="text-muted">Are you looking for an official childminder care at a childminder's home? With the childminder the groups of up to 6 children. This gives children more rest and less stimuli. As a result, they are more relaxed and come home rested. It is a small shelter in a homely atmosphere. Or are you looking for an official Nanny at your home in a familiar environment with a fixed face</p>
                ...
                <div class="col-lg-4 col-md-4 border">
                          ...
                          <h6 class="text-muted text-center mt-4 mb-4 ">Our working area: All of the Netherlands  
                  ...
                  <img class="img-responsive" src="assets/images/map.png">
                                     ...
                                     <p class="text-muted text-center"><strong>Find simple help questions and relaible helpers in all the Netherland, the team ensures improvement and growth everyday</strong>
</p>    
            ...
            <div class="row pt-4">
                <div class="col-lg-12">
                    <div id="owl-testi" class="owl-carousel owl-theme">
                        <div class="item testi-box rounded p-4 mr-3 ml-2 mb-4  position-relative">
                        
       <img src="assets/images/partner.png" alt="" class="img-fluid mx-auto d-block"></div>

     <div class="item testi-box rounded p-4 mr-3 ml-2 mb-4  position-relative">
                                  
       <img src="assets/images/partner1.png" alt="" class="img-fluid mx-auto d-block"></div>
           <div class="item testi-box rounded p-4 mr-3 ml-2 mb-4  position-relative">
                        
       <img src="assets/images/partner2.png" alt="" class="img-fluid mx-auto d-block"></div>

     <div class="item testi-box rounded p-4 mr-3 ml-2 mb-4  position-relative">
                                  
       <img src="assets/images/partner3.png" alt="" class="img-fluid mx-auto d-block"></div>
           <div class="item testi-box rounded p-4 mr-3 ml-2 mb-4  position-relative">
                        
       <img src="assets/images/partner4.png" alt="" class="img-fluid mx-auto d-block"></div>

     <div class="item testi-box rounded p-4 mr-3 ml-2 mb-4  position-relative">
                                  
       <img src="assets/images/partner5.png" alt="" class="img-fluid mx-auto d-block"></div>
                             <div class="item testi-box rounded p-4 mr-3 ml-2 mb-4 position-relative">   
          
       <img src="assets/images/partner6.png" alt="" class="img-fluid mx-auto d-block"></div>
...
<?php echo $__env->make('web.webLayout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/home/aboutus.blade.php ENDPATH**/ ?>