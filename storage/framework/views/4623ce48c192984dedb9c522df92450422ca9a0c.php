...
<script>
   ...
   $('#extra_chores_yes').on('change', function() {
    ...
    <div class="tabcontent pt-1 disable" id="tab2">
                ...
                <div class="row">
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      <?php echo e(Form::label('child[0][name]', __('Child name').':')); ?><span class="text-danger">*</span>
                      <?php echo e(Form::text('child[0][name]', null, ['class' => 'form-control required'])); ?>
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    <?php echo e(Form::label('child[0][gender]', __('messages.candidate.gender').':')); ?><span class="text-danger">*</span></br>
                    <?php echo e(Form::radio('child[0][gender]', 'male',"checked")); ?> <?php echo e(__('messages.common.male')); ?> &nbsp;&nbsp;&nbsp;
                    <?php echo e(Form::radio('child[0][gender]', 'female',"" )); ?> <?php echo e(__('messages.common.female')); ?>
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    <?php echo e(Form::label('child[0][dob]', __('messages.candidate.birth_date').':')); ?><span class="text-danger">*</span>
                    <?php echo e(Form::text('child[0][dob]', null, ['class' => 'form-control required userbirthDate','autocomplete' => 'off'])); ?>
                ...
                <div class="row form-group col-sm-12">
                    <a  id="AddNewChild"  href="javascript:void(0)" class="btn btn-primary" ><i class="fa fa-plus" aria-hidden="true"></i> <?php echo e(__('Child')); ?></a>
                </div>
    ...
    <div class="tabcontent pt-1 disable" id="tab3">
            <div class="custom-form">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      <?php echo e(Form::label('date_childcare_need', __('When do you need childcare?').':')); ?><span class="text-danger">*</span>
                      <?php echo e(Form::text('date_childcare_need', null, ['class' => 'form-control required pickdate'])); ?>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      <?php echo e(Form::label('type_of_care', __('Type of care').':')); ?><a href="#" class="tooltip_icon" data-toggle="tooltip" title="Fixed days, Flexible days, Occasionally, Emergency babysitter">?</a><span class="text-danger">*</span>
                      <?php echo e(Form::select('type_of_care',
                     ...
                     <?php echo e(Form::text('type_of_care_other', null, ['id'=>'type_of_care_other','class' => 'form-control other_box','placeholder'=>'Enter Other'])); ?>
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      <?php echo e(Form::label('preferred_reception', __('Preferred reception').':')); ?><span class="text-danger">*</span>
                      <?php echo e(Form::select('preferred_reception[]',
                      ...
                      <?php echo e(Form::text('preferred_reception_other', null, ['id'=>'preferred_reception_other','class' => 'form-control other_box','placeholder'=>'Enter Other'])); ?>
        ...
        <div class="form-group col-xl-12 col-md-12 col-sm-12" id="time_available_calendar">
               ...
               <div class="form-group col-sm-12">
                   <div style="float:left">
                    ...
                    <div style="float:right">
                        <a  onClick="validateTab(3)"  href="javascript:void(0)"  class="btn btn-primary" style="float: right;"><?php echo e(__('Next')); ?></a>
                    </div>
               </div>
    ...
    <div class="tabcontent pt-1 disable" id="tab4">
           ...
           <div class="row">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      <?php echo e(Form::label('have_pets', __('Do you have pets').':')); ?><span class="text-danger">*</span>
                      <?php echo e(Form::select('have_pets[]',
                     ['dog' =>'Dog' ,
                     'cat' =>'Cat' ,
                     'other'=>'Other animal',
                     'no'=>'No']
                    ...
                    <?php echo e(Form::text('have_pets_other', null, ['id'=>'have_pets_other','class' => 'form-control other_box','placeholder'=>'Enter Other'])); ?>
              ...
              <div class="row">
                    <div class="form-group col-xl-6 col-md-6 col-sm-12">
                          <?php echo e(Form::label('wish', __('Wish').':')); ?>
           ...
           <div class="row">
				<div class="col-md-2">
				    <?php echo e(Form::label('experience', __('Experience').':')); ?> <span id="span_minimum_exp"><?php echo e('1'); ?></span>
				    <?php echo e(Form::hidden('minimum_exp', '1', ['id' => 'minimum_exp', 'class' => 'form-control'])); ?>
				...
				<div class="col-md-2">
				    <span id="span_maximum_exp"><?php echo e('5'); ?></span>
				    <?php echo e(Form::hidden('maximum_exp', '5', ['id' => 'maximum_exp', 'class' => 'form-control'])); ?>
             ...
             <div class="row">
				<div class="col-md-2">
				    <?php echo e(Form::label('age', __('Age').':')); ?> <span id="span_minimum_age"><?php echo e('16'); ?></span>
				    <?php echo e(Form::hidden('minimum_age', '16', ['id' => 'minimum_age', 'class' => 'form-control'])); ?>
				...
				<div class="col-md-2">
				    <span id="span_maximum_age"><?php echo e('45'); ?></span>
				    <?php echo e(Form::hidden('maximum_age', '45', ['id' => 'maximum_exp', 'class' => 'form-control'])); ?>
             ...
             <div class="row">
                 ...
                 <div class="row">
                               <div class="form-group col-xl-6 col-md-5 col-sm-6">
                                    <?php echo e(Form::label('wish_lang[0][name]', __('Language').':')); ?>

                                    <?php echo e(Form::select('wish_lang[0][name]', $data['language'],null, ['class' => 'form-control select-box','placeholder' => 'Select Langauge'])); ?>
                        ...
                        <div  id="additionalWishLang">
                          ...
                          <div class="row form-group col-sm-12">
                                <a id="AddNewWishLanguage"  href="javascript:void(0)" class="btn btn-primary" ><i class="fa fa-plus" aria-hidden="true"></i> <?php echo e(__('Langauge')); ?></a>
                            </div>
              ...
              <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    <?php echo e(Form::label('need_extra_care', __('Do your child(ren) need extra care').':')); ?><a href="#" class="tooltip_icon" data-toggle="tooltip" title="Such as: my child is diabetic or my child has medical indiction or orher">?</a><span class="text-danger">*</span></br>
                    <?php echo e(Form::radio('need_extra_care', '1',false),['class' => 'form-control check-box required']); ?> <?php echo e(__('Yes')); ?>

                    &nbsp;&nbsp;&nbsp;
                    <?php echo e(Form::radio('need_extra_care', '0',true),['class' => 'form-control check-box required']); ?> <?php echo e(__('No')); ?>
             ...
             <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    <?php echo e(Form::label('need_extra_care_child[0][like_what]', __('Like what').':')); ?>

                    <?php echo e(Form::text('need_extra_care_child[0][like_what]', null, ['class' => 'form-control'])); ?>
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    <?php echo e(Form::label('need_extra_care_child[0][name]', __('The name of the child').':')); ?>

                    <?php echo e(Form::text('need_extra_care_child[0][name]', null, ['class' => 'form-control'])); ?>
            ...
            <div class="row form-group col-sm-12">
                <a id="AddNewExtraCareChild"  href="javascript:void(0)" class="btn btn-primary" ><i class="fa fa-plus" aria-hidden="true"></i> <?php echo e(__('ADD')); ?></a>
            </div>
             ...
             <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    <?php echo e(Form::label('extra_chores', __('Do you want the babysitter to do extra chores around the house').':')); ?><a href="#" class="tooltip_icon" data-toggle="tooltip" title="Such as: my child is diabetic or my child has medical indiction or orher">?</a><span class="text-danger">*</span></br>
                    <?php echo e(Form::radio('extra_chores', '1',false),['class' => 'form-control check-box required']); ?> <?php echo e(__('Yes')); ?>

                    &nbsp;&nbsp;&nbsp;
                    <?php echo e(Form::radio('extra_chores', '0',true),['class' => 'form-control check-box required']); ?> <?php echo e(__('No')); ?>
              ...
              <div class="row" id="extra_chores_yes_box" style="display:none">
               ...
               <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      <?php echo e(Form::label('extra_chores_yes', __('Like what').':')); ?><span class="text-danger">*</span>
                      <?php echo e(Form::select('extra_chores_yes[]',
                     ['Craft' =>'Craft' ,
                     'Cook' =>'Cook' ,
                    ...
                    <?php echo e(Form::text('extra_chores_yes_other', null, ['id'=>'extra_chores_yes_other','class' => 'form-control other_box','placeholder'=>'Enter Other'])); ?>
    ...
    <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                      <?php echo e(Form::label('remarks', __('Remarks').':')); ?><a href="#" class="tooltip_icon" data-toggle="tooltip" title="Do you hvae any comments that are important for the babysister, for example: prefer not to smoke or rather someone who is not afraid of animals or someone who has experience with crying babies">?</a>
                      <?php echo e(Form::textarea('remarks', null, ['class' => 'form-control','row'=>'5'])); ?>
       ...
       <div style="float:left">
        ...
        <div style="float:right">
            <a  onClick="validateTab(4)"   class="btn btn-primary" style="float: right;"><?php echo e(__('Next')); ?></a>
        </div>
       </div>
    ...
    <div class="tabcontent  disable pt-1 " id="tab5">
        ...
        <div style="float:right">
            <a  onClick="validateTab(5)"  href="javascript:void(0)"  class="btn btn-primary" style="float: right;"><?php echo e(__('Next')); ?></a>
        </div>
        </div>
     </div>
    </div>
    ...
    <div class="custom-form">
        ...
        <div class="row">
           ...
           <div class="form-group col-sm-12">
             <div style="float:left">
                <a href="javascript:void(0)" onClick="openCity(event, 'tab5','tabb5')" class="btn btn-secondary text-dark"><?php echo e(__('Previous')); ?></a>
            </div>
             <div  style="float:right">
                <a  onClick="ValidateAndSave(6)" href="javascript:void(0)" class="btn btn-primary" style="float: right;"><?php echo e(__('Next')); ?></a>
            </div>
            </div>
...
<?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/services_request_forms/form_fields_1.blade.php ENDPATH**/ ?>