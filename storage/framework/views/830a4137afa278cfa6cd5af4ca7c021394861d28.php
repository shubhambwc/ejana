        ...
        <div class="">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <img class="img-responsive" src="<?php echo e(asset('assets/img/hero-image.png')); ?>">
                    </div>
...
<section class="section section-service">
        ...
        <?php if($jobCategories) { foreach($jobCategories as $jobCategory){
            ...
            <div class="icon"> <img src="<?php echo e($jobCategory->thumbnail); ?>" alt="" class="img-fluid mx-auto d-block"></div>
            <p class="title"> <h5 class="f-18 text-center"><a href="<?php echo e(route('service-details',$jobCategory->id)); ?>" class="text-dark"><?php echo e($jobCategory->name); ?> </a></h5></p>
            <p class="text"><span class="txt">( <?php echo e(DB::table('users')->where('service_id', $jobCategory->id)->where('owner_type', 'App\Models\Company')->count()); ?> Jobs)</span><br><?php echo e(Str::limit($jobCategory->description,20)); ?><br><a href="<?php echo e(route('service-details',$jobCategory->id)); ?>">Read More</a> </p>
            <p></p>
                ...
                <div class="row mb-4 pb-5">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12 col-sm-8 col-xs-12 align-items-center">
                                <div align="center" class="pt-2">
                                    <img src="<?php echo e(asset('assets/img/search-icon.png')); ?>" alt="" class="img-fluid mx-auto d-block mb-4">
                    ...
                    <div class="col-lg-4 col-md-4 mt-4 pt-2">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-sm-8 col-xs-12 align-items-center">
                                <div align="center" class="pt-2">
                                    <img src="<?php echo e(asset('assets/img/candidate.png')); ?>" alt="" class="img-fluid mx-auto d-block mb-4">
                    ...
                    <div class="col-lg-4 col-md-4 mt-4 pt-2">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-sm-8 col-xs-12 align-items-center">
                                <div align="center" class="pt-2">
                                    <img src="<?php echo e(asset('assets/img/booking.png')); ?>" alt="" class="img-fluid mx-auto d-block mb-4">
                    ...
                    <div class="item testi-box rounded p-4 mr-3 ml-2 mb-4 bg-light position-relative">
                        ...
                        <div class="clearfix">
                            <div class="testi-img float-left mr-3">
                                <img src="<?php echo e(asset('assets/img/user.png')); ?>" height="80" alt="" class="rounded-circle shadow">
                            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mt-4 pt-2 border-custom ">
                    <div class="row ">
                        <div class="col-md-12 col-sm-12 col-xs-12 border-custom-bottom ">
                            <div class="pt-2 mb-4">
                                <img src="<?php echo e(asset('assets/img/verified.png')); ?>" alt="" class="img-icon">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 mt-3">
                            <div class="pt-2 mb-4">
                                <img src="<?php echo e(asset('assets/img/deal-4.png')); ?>" alt="" class="img-icon">
                ...
                <div class="col-lg-4 col-md-6 mt-4 pt-2">
                    <div class="row ">
                        <div class="col-md-12 col-sm-12 col-xs-12 border-custom-bottom">
                            <div class="pt-2 mb-4">
                                <img src="<?php echo e(asset('assets/img/deal-2.png')); ?>" alt="" class="img-icon">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 mt-3 ">
                            <div class="pt-2 mb-4">
                                <img src="<?php echo e(asset('assets/img/deal-5.png')); ?>" alt="" class="img-icon">
                ...
                <div class="col-lg-4 col-md-6 mt-4 pt-2">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-sm-12 col-xs-12 border-custom-left border-custom-bottom">
                            <div class="pt-2 mb-4">
                                <img src="<?php echo e(asset('assets/img/deal-3.png')); ?>" alt="" class="img-icon">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 border-custom-left ">
                            <div class="pt-2 mb-4 mt-3">
                                <img src="<?php echo e(asset('assets/img/deal-6.png')); ?>" alt="" class="img-icon">
        ...
        <div class="row ">
            <div class="col-lg-6 col-md-5 signup-section">
                <div align="center" class="pt-2">
                    ...
                    <img src="<?php echo e(asset('assets/img/signup-icon1.png')); ?>" alt="" class="img-fluid mx-auto d-block mb-4">
            ...
            <div class="col-lg-6 col-md-6 mt-4 mt-sm-0 section-service11 signup-section">
                <div align="center" class="pt-2">
                    <img src="<?php echo e(asset('assets/img/signup-icon2.png')); ?>" alt="" class="img-fluid mx-auto d-block mb-4">
...
<?php echo $__env->make('web.webLayout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/home/home.blade.php ENDPATH**/ ?>