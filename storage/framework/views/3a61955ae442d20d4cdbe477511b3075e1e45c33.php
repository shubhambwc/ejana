...
<body>
    ...
    <!--   footer -->
    <footer class="footer">
        <?php echo $__env->make('webLayout.homefooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </footer>
  ...
  <!--   <script src="<?php echo e(asset('assets/js/plugins.js' )); ?>"></script> -->
    ...
    <script src="<?php echo e(asset('assets/js/app1.js' )); ?>"></script>
...
</html><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/webLayout/home.blade.php ENDPATH**/ ?>