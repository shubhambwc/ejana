...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> | <?php echo e(__('web.helpers')); ?> </title>
...
<div id="app">
    ...
    <?php echo $__env->make('candidate.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('candidate_profile.edit_profile_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('candidate_profile.change_password_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    let profileUrl = "<?php echo e(url('candidate/edit-profile')); ?>";
    let profileUpdateUrl = "<?php echo e(url('candidate/edit-profile-update')); ?>";
    let updateLanguageURL = "<?php echo e(url('update-language')); ?>";
    let changePasswordUrl = "<?php echo e(url('candidate/edit-change-password')); ?>";
    let loggedInUserId = "<?php echo e(getLoggedInUserId()); ?>";
    let readAllNotifications = "<?php echo e(url('candidate/read-all-notification')); ?>";
    let readNotification = "<?php echo e(url('candidate/notification')); ?>";
</script>
<script src="<?php echo e(mix('assets/js/candidate_profile/candidate_profile.js')); ?>"></script>
<script src="<?php echo e(asset('js/currency.js')); ?>"></script>
</body>
</html>
<?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/candidate/layouts/app.blade.php ENDPATH**/ ?>