...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('messages.candidate.candidate_details')); ?>
...
<p>Aliquam erat volutpat Etiam vitae tortor Morbi vestibulum volutpat enim Aliquam nunc Nunc sed turpis sed mollis eros et ultrices tempus mauris ipsum aliquam </p>
        ...
        <div class="container">
            <div class="row candidate-profile">
                ...
                <div class="col-md-3 col-xs-12">
                    <div class="profile-photo ticket-sender-picture">
                        <img src="<?php echo e($candidateDetails->user->avatar); ?>" class="img-responsive" alt="">
                    </div>

                    <ul class="social-btns list-inline text-center mt20">

                        <?php if(! empty($candidateDetails->user->facebook_url)): ?>
                            <li>
                                <a href="<?php echo e((isset($candidateDetails->user->facebook_url)) ? $candidateDetails->user->facebook_url : 'javascript:void(0)'); ?>"
                        ...
                        <?php endif; ?>
                        <?php if(! empty($candidateDetails->user->twitter_url)): ?>
                            <li>
                                <a href="<?php echo e((isset($candidateDetails->user->twitter_url)) ? $candidateDetails->user->twitter_url : 'javascript:void(0)'); ?>"
                        ...
                        <?php endif; ?>
                        <?php if(! empty($candidateDetails->user->google_plus_url)): ?>
                            <li>
                                <a href="<?php echo e((isset($candidateDetails->user->google_plus_url)) ? $candidateDetails->user->google_plus_url : 'javascript:void(0)'); ?>"
                        ...
                        <?php endif; ?>
                        <?php if(! empty($candidateDetails->user->pinterest_url)): ?>
                            <li>
                                <a href="<?php echo e((isset($candidateDetails->user->pinterest_url)) ? $candidateDetails->user->pinterest_url : 'javascript:void(0)'); ?>"
                        ...
                        <?php endif; ?>
                        <?php if(! empty($candidateDetails->user->linkedin_url)): ?>
                            <li>
                                <a href="<?php echo e((isset($candidateDetails->user->linkedin_url)) ? $candidateDetails->user->linkedin_url : 'javascript:void(0)'); ?>"
                ...
                <div class="col-md-9 col-xs-12">
                    <div class="profile-descr">
                        ...
                        <div class="profile-title">
                            <h2 class="capitalize"><?php echo e(html_entity_decode($candidateDetails->user->full_name)); ?></h2>
                            <h5 class="pt10"><?php echo e($candidateDetails->functionalArea->name ?? ''); ?></h5>
                        </div>
                        <div class="row">
                            <?php if(!empty($candidateDetails->user->country_name)): ?>
                                <div class="col-lg-4 mb10">
                                    <i class="fa fa-map-marker"></i>

                                    <span><?php echo e($candidateDetails->user->country_name); ?>

                                        <?php if(!empty($candidateDetails->user->state_name)): ?>
                                            , <?php echo e($candidateDetails->user->state_name); ?>

                                        <?php endif; ?>
                                        <?php if(!empty($candidateDetails->user->city_name)): ?>
                                            , <?php echo e($candidateDetails->user->city_name); ?></span>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                            <div class="col-lg-4 mb10">
                                <i class="fa fa-envelope"></i>
                                <span><?php echo e($candidateDetails->user->email); ?></span>
                            </div>
                            <?php if(!empty($candidateDetails->user->dob)): ?>
                                <div class="col-lg-4 mb10">
                                    <i class="fa fa-birthday-cake"></i>
                                    <span>
                                        <?php echo e(date('jS M, Y', strtotime($candidateDetails->user->dob))); ?>

                                </span>
                                </div>
                            <?php endif; ?>
                            <?php if(isset($candidateDetails->user->phone)): ?>
                                <div class="col-lg-4">
                                    <i class="fa fa-phone"></i>
                                    <span><?php echo e($candidateDetails->user->phone); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-offset-12 ml-0 col-md-6 reportJobBtn">
                                    <div class="company-report-web company-web clearfix">
                                        <button
                                                class="mt15 btn btn-small btn-red btn-effect reportToCompany reportToCandidate <?php echo e(($isReportedToCandidate) ? 'disabled' : ''); ?>"
                                                data-toggle="modal"
                                                data-target="#reportToCandiateModal">
                                            <?php echo e(__('messages.candidate.reporte_to_candidate')); ?>
            ...
            <div class="job-header mt30 box-shadow">
                <div class="contentbox">
                    <h3><?php echo e(__('messages.skills')); ?></h3>
                    <div class="row skillbar">
                        <?php if($candidateDetails->user->candidateSkill->count()): ?>
                            <?php $__currentLoopData = $candidateDetails->user->candidateSkill; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidateSkill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6 col-xs-12 mt20">
                                    <div class="skillbar-title mr-xy-auto one-line-truncate">
                                        <span><?php echo e(html_entity_decode($candidateSkill->name)); ?></span>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <h4 class="text-center"><?php echo e(__('messages.skill.no_skill_available')); ?></h4>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="job-header mt30 box-shadow">
                <div class="contentbox">
                    <h3><?php echo e(__('messages.candidate_profile.education')); ?></h3>
                    <ul class="educationList">
                        <?php $__empty_1 = true; $__currentLoopData = $candidateEducations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidateEducation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li>
                                <div class="date educationCard"><?php echo e($candidateEducation->year); ?></div>
                                <div class="education-card">
                                    <h4><?php echo e($candidateEducation->degreeLevel->name); ?></h4>
                                    <?php if(!empty($candidateEducation->country_name)): ?>
                                        <label class="text-muted">
                                            <i class="fa fa-map-marker"></i> <?php echo e($candidateEducation->country_name); ?>
                                    ...
                                    <span class="text-muted font-weight-bolder">
                                            <?php echo e(__('messages.candidate_profile.institute').' : '.$candidateEducation->institute); ?>

                                    </span>
                                        </div>
                                        <div class="col-md-4">
                                    <span class="text-muted font-weight-bolder">
                                        <?php echo e(__('messages.candidate_profile.result').' : '.$candidateEducation->result); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <h4 class="text-center"><?php echo e(__('messages.candidate.education_not_found')); ?></h4>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
            ...
            <div class="job-header mt30 box-shadow">
                <div class="contentbox">
                    <h3><?php echo e(__('messages.candidate.experience')); ?></h3>
                    <ul class="experienceList">
                        <?php $__empty_1 = true; $__currentLoopData = $candidateExperiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidateExperience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li>
                                <div class="date">
                                    <?php echo e(\Carbon\Carbon::parse($candidateExperience->start_date)->format('Y')); ?>

                                    <br>-<br>
                                    <?php echo e(($candidateExperience->currently_working) ? 'present' : \Carbon\Carbon::parse($candidateExperience->end_date)->format('Y')); ?>

                                </div>
                                <div class="row">
                                    <div class="col-md-10">
                                        <h4><?php echo e($candidateExperience->company); ?></h4>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <?php if(!empty($candidateExperience->country_name)): ?>
                                                    <label class="text-muted">
                                                        <i class="fa fa-map-marker"></i>
                                                        <?php echo e($candidateExperience->country_name); ?>

                                                    </label>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <?php if(!empty($candidateExperience->description)): ?>
                                            <p class="text-muted"
                                               data-toggle="tooltip"><?php echo nl2br($candidateExperience->description); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <h4 class="text-center"><?php echo e(__('messages.candidate.experience_not_found')); ?></h4>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
    ...
    <?php if(auth()->check() && auth()->user()->hasRole('Employer')): ?>
    <?php echo $__env->make('web.candidate.report_to_candidate_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('scripts'); ?>
    <script>
        let reportToCandidateUrl = "<?php echo e(route('report.to.candidate')); ?>";
    </script>
    <script src="<?php echo e(asset('assets/js/select2.min.js')); ?>"></script>
    <script src="<?php echo e(mix('assets/js/candidate/front/candidate-details.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/candidate/candidate_details.blade.php ENDPATH**/ ?>