...
HOW DO YOU FIND YOUR IDEAL JOB?</strong>
    ...
    <section class="section section-service" id="our_service">
        ...
        <?php if($jobCategories) { foreach($jobCategories as $jobCategory){
            ...
            <p class="text"><span class="txt">(8 Jobs)</span><br><?php echo e(Str::limit($jobCategory->description,20)); ?><br><a href="<?php echo e(route('service-details',$jobCategory->id)); ?>">Read More</a> </p>
            <p></p>
                ...
                <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0 ">
                    <div class="pricing-box border rounded pt-4">
                        ...
                        <div class="text-center border-top p-4">
                         <?php echo e(Form::open(array('route' => 'choose-service'))); ?>
...
<?php echo $__env->make('web.webLayout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/home/findjob.blade.php ENDPATH**/ ?>