...
<table class="table table-responsive-sm table-striped table-bordered" id="remindTable">
    ...
    <tr>
            ...
            <td class="text-center">
               ...
               <a href="<?php echo e(URL('admin/moments/'.$moment->id.'/edit' )); ?>" title="Edit" class="btn btn-warning action-btn" data-id="<?php echo e($moment['id']); ?>" id="<?php echo e($moment['id']); ?>">
...
<script src="<?php echo e(asset('assets/js/jquery.dataTables.min.js')); ?>"></script>
    ...
    <?php $__env->stopPush(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/companies/reminder/table.blade.php ENDPATH**/ ?>