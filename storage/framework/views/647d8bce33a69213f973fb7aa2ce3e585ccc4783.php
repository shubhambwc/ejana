            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="text-center text-white inner-title">
                       ...
                       <a href="<?php echo e(route('front.home')); ?>" class="text-uppercase font-weight-bold">Home</a> > <span class="text-uppercase text-white font-weight-bold">How it works</span>
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-lg-12 col-md-12 mt-4 mt-sm-0 text-center">
                       ...
                       <a href="<?php echo e(route('pricing-candidate')); ?>">Click here</a></p>
...
Did you find a nice helper?  Contact that helper with you <br>get to know each other evenbetter. 
    ...
    <a href="<?php echo e(route('pricing-employer')); ?>" class="btn btn-1 mt-4"></i>
...
<?php echo $__env->make('web.webLayout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/home/howitworks.blade.php ENDPATH**/ ?>