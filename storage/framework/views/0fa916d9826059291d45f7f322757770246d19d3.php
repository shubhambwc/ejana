            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="text-center text-white inner-title">
                        <h3 class="text-uppercase title mb-4">Candidate Pricing</h3>
                          <a href="/" class="text-uppercase font-weight-bold">Home</a> > <span class="text-uppercase text-white font-weight-bold">Candidate Pricing</span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="pl-2 pr-2">
                            ...
                            <div class="pricing-plan-item text-center">
                                <ul class="list-unstyled mb-4">
                                    <li class="text-muted">Eigenprofiel

</li>

                                    <li class="text-muted">Find profiles
</li>
...
<h3 class=" heading mb-1">Benefits of working through Ejana</h3>
                        <div class="job-details-desc-item">
                        <div class="float-left mr-3">
                            <i class="mdi mdi-checkbox-marked-circle-outline text-muted f-16"></i>
                        </div>
                        <p class="text-muted f-14 mb-1">You work in your own Region


</p>
 <div class="float-left mr-3">
                 <i class="mdi mdi-checkbox-marked-circle-outline text-muted f-16"></i>
                        </div><p class="text-muted f-14 mb-1">Secure payment via IDEAL</p>
  <div class="float-left mr-3">
                              <i class="mdi mdi-checkbox-marked-circle-outline text-muted f-16"></i>
                        </div> <p class="text-muted f-14 mb-1">Schedule your own calendar when you can be flexible, fixed or occasionally


</p>
 <div class="float-left mr-3">
                 <i class="mdi mdi-checkbox-marked-circle-outline text-muted f-16"></i>
                        </div><p class="text-muted f-14 mb-1">Choose your own hourly rate</p>
  <div class="float-left mr-3">
                              <i class="mdi mdi-checkbox-marked-circle-outline text-muted f-16"></i>
                        </div> <p class="text-muted f-14 mb-1">You work all white


</p>
  <div class="float-left mr-3">
                              <i class="mdi mdi-checkbox-marked-circle-outline text-muted f-16"></i>
                        </div> <p class="text-muted f-14 mb-1">Personal customer service and guidance in administration
...
<?php echo $__env->make('web.webLayout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/home/pricing-candidate.blade.php ENDPATH**/ ?>