                    ...
                    <div class="pricing-box border rounded pt-4  ">
                        <div align="center" class="pt-2">
                             <img src="assets/images/signup-icon1.png" alt="" class="img-fluid mx-auto d-block mb-4">
 							 <h4 class="f-18"><a href="<?php echo e(route('pricing-employer')); ?>" class="text-dark">I AM AN EMPLOYER</a></h4>
                    ...
                    <div class="pricing-box border rounded pt-4">
                       <div align="center" class="pt-2">
                          <img src="assets/images/signup-icon2.png" alt="" class="img-fluid mx-auto d-block mb-4">
 						  <h4 class="f-18"><a href="<?php echo e(route('pricing-candidate')); ?>" class="text-dark">I AM AN CANDIDATE</a></h4>
                          <p class="text-muted mb-0">Did you find a nice helper?  Contact that helper with you <br>get to know each other evenbetter.</p> 
   						   <?php echo e(Form::open(array('route' => 'choose-service'))); ?>
...
<?php echo $__env->make('web.webLayout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/home/pricing.blade.php ENDPATH**/ ?>