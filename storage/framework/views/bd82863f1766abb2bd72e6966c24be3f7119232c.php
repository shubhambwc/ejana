...
<table class="table table-responsive-sm table-striped table-bordered" id="momentTable">
    ...
    <tr>
         <td><?php echo e($i); ?></td>
            <td><a href="/admin/helper/<?php echo e($job_application->owner_id); ?>/edit"> <?php echo e($job_application->first_name); ?> <?php echo e($job_application->last_name); ?></a></td>
            <td><?php echo e($job_application->created_at); ?></td>
            <td><?php echo e($job_application->name); ?></td>
...
let tableId = '#momentTable';
    ...
    <?php $__env->stopPush(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/companies/job_application/table.blade.php ENDPATH**/ ?>