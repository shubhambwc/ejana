...
<script>
    ...
    $('input[type=radio][name=should_take_into_account]').change(function() {
    	if (this.value == 1) {
    		$('#should_take_into_account_yes').show();
    	}else{
    		$('#should_take_into_account_yes').hide();
    	}
    ...
    <div class="tabcontent pt-1 disable" id="tab3">
           ...
           <div class="custom-form">
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  <?php echo e(Form::checkbox('preference[]', 'Plan activities', false) ,['class' => 'form-control check-box']); ?>

                  <?php echo e(Form::label('preference[]', __('Plan activities'))); ?>

                  </p>

                  <p>
                  <?php echo e(Form::checkbox('preference[]', 'Keep the elderly company', false) ,['class' => 'form-control check-box']); ?>

                  <?php echo e(Form::label('preference[]', __('Keep the elderly company'))); ?>

                  </p>
                  <p>
                  <?php echo e(Form::checkbox('preference[]', 'Doing activities/hoby with the elderly/trips', false) ,['class' => 'form-control check-box']); ?>

                  <?php echo e(Form::label('preference[]', __('Doing activities/hoby with the elderly/trips'))); ?>

                  </p>
                  <p>
                  <?php echo e(Form::checkbox('preference[]', 'Domestic help', false) ,['class' => 'form-control check-box']); ?>

                  <?php echo e(Form::label('preference[]', __('Domestic help'))); ?>

                  </p>
                  <p>
                  <?php echo e(Form::checkbox('preference[]', 'Shopping service/shopping', false) ,['class' => 'form-control check-box']); ?>

                  <?php echo e(Form::label('preference[]', __('Shopping service/shopping'))); ?>

                  </p>
                  <p>
                  <?php echo e(Form::checkbox('preference[]', 'Visiting the elderly to talk', false) ,['class' => 'form-control check-box']); ?>

                  <?php echo e(Form::label('preference[]', __('Visiting the elderly to talk'))); ?>
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                  <p>
                  <?php echo e(Form::checkbox('preference[]', 'Social support', false) ,['class' => 'form-control check-box']); ?>

                  <?php echo e(Form::label('preference[]', __('Social support'))); ?>

                  </p>
                  <p>
                  <?php echo e(Form::checkbox('preference[]', 'Assiging with appointments ar the hospital of with the general practioner', false) ,['class' => 'form-control check-box']); ?>

                  <?php echo e(Form::label('preference[]', __('Assiging with appointments ar the hospital of with the general practioner'))); ?>

                  </p>
                  <p>
                  <?php echo e(Form::checkbox('preference[]', 'Reading the newspaper together to the library', false) ,['class' => 'form-control check-box']); ?>

                  <?php echo e(Form::label('preference[]', __('Reading the newspaper together to the library'))); ?>

                  </p>
                  <p>
                  <?php echo e(Form::checkbox('preference[]', 'Internet and mail', false) ,['class' => 'form-control check-box']); ?>

                  <?php echo e(Form::label('preference[]', __('Internet and mail'))); ?>

                  </p>
                  <p>
                  <?php echo e(Form::checkbox('preference[]', 'In Construction with helpper', false) ,['class' => 'form-control check-box']); ?>

                  <?php echo e(Form::label('preference[]', __('In Construction with helpper'))); ?>

                  </p>
                  <p>
                  <input name="preference[]" type="checkbox" value="other" class="preference_other_name">
                  <?php echo e(Form::label('preference[]', __('Other'))); ?>

                  </p>
                </div>
                <div class="form-group col-xl-6 col-md-6 col-sm-12">
                 <?php echo e(Form::text('preference_other', null, ['id'=>'preference_other','class' => 'form-control other_box','placeholder'=>'Enter Other'])); ?>
            ...
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    <?php echo e(Form::label('should_take_into_account', __('Are there points that the helpers should take into account').':')); ?><a href="#" class="tooltip_icon" data-toggle="tooltip" title="Such as: diabetic or medical indiction or orher">?</a><span class="text-danger">*</span></br>
                    <?php echo e(Form::radio('should_take_into_account', '1',false),['class' => 'form-control check-box required']); ?> <?php echo e(__('Yes')); ?>

                    &nbsp;&nbsp;&nbsp;
                    <?php echo e(Form::radio('should_take_into_account', '0',true),['class' => 'form-control check-box required']); ?> <?php echo e(__('No')); ?>
             ...
             <div class="row" id="should_take_into_account_yes" style="display:none">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    <?php echo e(Form::label('like_what', __('Like What').':')); ?><span class="text-danger">*</span></br>
              ...
              <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 col-sm-6">
                    <?php echo e(Form::label('extra_chores', __('Do you want the helper to do extra chores around the house').':')); ?><a href="#" class="tooltip_icon" data-toggle="tooltip" title="Such as: my child is diabetic or my child has medical indiction or orher">?</a><span class="text-danger">*</span></br>
...
<?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/services_request_forms/form_fields_9.blade.php ENDPATH**/ ?>