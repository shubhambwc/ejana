...
<head>
    ...
    <title>EJana - <?php if(isset($title)): ?><?php echo e($title); ?><?php else: ?> Job Portal  <?php endif; ?></title>
    ...
    <!-- Custom  Css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/style.css')); ?>?t=<?php echo time();?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/style1.css')); ?>?t=<?php echo time();?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/bootstrap-datetimepicker.css')); ?>">
...
<script src="<?php echo e(asset('assets/js/captcha/jquery.clientsidecaptcha.js')); ?>" type="text/javascript"></script>
...
<body>
    ...
    <header id="topnav" class="defaultscroll scroll-active">
        <?php echo $__env->make('web.webLayout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </header>
...
<script src="<?php echo e(asset('messages.js')); ?>"></script>
    ...
    <script>
     ...
     <!-- These Script for Append HTML -->
                 <script>
let changeLanguage = "<?php echo e(url('change-language')); ?>";
...
$('#additional_reference').on('click','.remove-reference',function(){
   ...
   <!-- Script for tabs of forms -->
          ...
          <script src="<?php echo e(asset('assets/js/candidate/front/create-helper.js')); ?>"></script>
...
<?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/webLayout/app.blade.php ENDPATH**/ ?>