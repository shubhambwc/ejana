            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class=" text-white inner-title">
                        <h5 class="text-uppercase title text "><?php echo e($JobCategoryDetail->name); ?> Service Request Details</h5>
                    </div>
                </div>
                 <div class="col-md-6">
...
<div class="row">
              ...
              <div class="rounded shadow bg-white p-4">
                           ...
                           <?php echo e(Form::hidden('MultipleServices',$MultipleServices)); ?>
                            ...
                            <?php echo $__env->make('web.services_request_forms.form_fields_'.$serviceId, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('web.webLayout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/psd2htmlx.com/ejana/resources/views/web/services_request_forms/index.blade.php ENDPATH**/ ?>